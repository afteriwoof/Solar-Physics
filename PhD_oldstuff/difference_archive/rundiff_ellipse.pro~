...
pro rundiff_ellipse, path=path, features, tangents=tangents, previous=previous, lines=lines
...
win_x = 800
win_y = win_x
temparr = fltarr(win_x, win_y, szd[2])
window, 0, xs=win_x, ys=win_y, tit='rundiff_ellipse'
...
wr_movie, 'CME_rundiff_ellipse3', temparr
