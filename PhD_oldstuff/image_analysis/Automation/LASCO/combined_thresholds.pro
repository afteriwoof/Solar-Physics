...
PRO combined_thresholds, in, da, filt, scalemasks_org, mults, magchains, combined, dilations, frontmasks, mov
...
; 3) Use the original data to do the scale chaining (denoising).
	...
	scale_chain, da, scalemasks_org

; 4) Assign the interval of data a certain thresholding of the scalemasks.
	assign_scale, scalemasks_org, da, scalemasks_new
	scalemasks = scalemasks_new
	delvarx, scalemasks_new
