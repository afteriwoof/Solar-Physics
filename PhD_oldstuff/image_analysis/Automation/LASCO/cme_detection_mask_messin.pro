...
pro cme_detection_mask_messin, in, da, modgrads, alpgrads, circ_pol, list, cme_detect, cme_masks, show=show
...
cme_masks = bytarr(sz_mod[0], sz_mod[1], sz_mod[2])
