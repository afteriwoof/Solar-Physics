...
; for each scale in the decomp.	
	...
	alp1 = rm_inner(alpgrads[*,*,s], in, dr_px, thr=thr1)
	alp1 = rm_outer(alp1, in, dr_px, thr=thr2)
	mod1 = rm_inner(modgrads[*,*,s], in, dr_px, thr=thr1)
	mod1 = rm_outer(mod1, in, dr_px, thr=thr2)
	mod_rm = mod1
