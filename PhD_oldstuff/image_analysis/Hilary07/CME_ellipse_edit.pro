...
; Last edited 20-03-07


pro CME_ellipse_edit, tangents=tangents, previous=previous, lines=lines
...
for i=0,szd[2]-1 do begin
	...
	mu = moment( diffn(600:1000, 10:200, i), sdev=sdev)
	thresh = mu[0] + 6.*sdev
