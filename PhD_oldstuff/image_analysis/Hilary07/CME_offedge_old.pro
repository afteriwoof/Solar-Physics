...
pro CME_offedge_old, final_front_x, final_front_y, x_next, y_next, req_x_front, req_y_front, front_arr_x, front_arr_y, next_front, front_vel, front_arr_r, tangents=tangents, previous=previous, lines=lines
...
;						plots, req_x_front[*,*,i+1], req_y_front[*,*,i+1], psym=6, color=6				
		...
		help, final_front_x, final_front_y
	endfor
