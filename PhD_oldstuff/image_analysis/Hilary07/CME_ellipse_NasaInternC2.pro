...
; Last edited 15-03-07


pro CME_ellipse_NasaInternC2, tangents=tangents, previous=previous, lines=lines
...
;save, da, filename='da_NasaIntern.sav'
;save, in, filename='in_NasaIntern.sav'

restore, '~/PhD/Data_sav_files/in_NasaIntern.sav'
;restore, '~/PhD/Data_sav_files/da.sav'
;restore, '~/PhD/Data_sav_files/in.sav'
;restore, '~/PhD/Data_sav_files/da_21apr2002.sav'
;restore, '~/PhD/Data_sav_files/in_21apr2002.sav'
;restore, '~/PhD/Data_sav_files/da_221194.sav'
;restore, '~/PhD/Data_sav_files/in_221194.sav'


;***
; Putting in the analysis on James' 21apr2002 lvl1.0 data
...
restore, '~/PhD/Data_sav_files/da_NasaIntern_ssw.sav'
...
;	im = da(*,*,i)
	...
	; Remove inner disk
;	im = rm_inner( im, in[i], dr_px, thr=2.2, plot=plot, fill=fill)
...
restore, '~/PhD/Data_sav_files/da_norm_NasaIntern.sav'
restore, '~/PhD/Data_sav_files/danb_NasaIntern.sav'
;restore, '~/PhD/Data_sav_files/da_norm_21apr2002.sav'
;restore, '~/PhD/Data_sav_files/danb_21apr2002.sav'
...
for i=0,sz[2]-2 do begin
	...
	diffnb(*,*,i) = bytscl( diffn(*,*,i), -200.,200.0)

endfor

;xstepper, diffn, xs=500, ys=500
;xstepper, diffnb, xs=500, ys=500
...
;****************************************************
		...
		x_front_nonzeros = where(x_front ne 0.)
		x_front = x_front(x_front_nonzeros)
		y_front = y_front(x_front_nonzeros)
		y_front_nonzeros = where(y_front ne 0.)
		x_front = x_front(y_front_nonzeros)
		y_front = y_front(y_front_nonzeros)
