...
pro CME_offedge_showoff, final_front_x, final_front_y, x_next, y_next, req_x_front, req_y_front, front_arr_x, front_arr_y, next_front, front_vel, front_arr_r, tangents=tangents, previous=previous, lines=lines
...
for i=0,szd[2]-2 do begin
	...
	for k=0,c-1 do begin
		...
		plots, final_front_x[*,k,i], final_front_y[*,k,i], psym=2, color=2
