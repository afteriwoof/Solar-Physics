; Attempts at removing the flickering of the data 18-apr-2000 written following batch file readin.bat
...
; Doing the tricks James was doing: ssw_fill_cube2.pro
; Remove inner disk (it may be introducing errors) rm_inner.pro

;ssw_fill_cube2, da, da_out
