...
pro CME_ellipse2, tangents=tangents, previous=previous, lines=lines
...
;save, da_norm, filename='da_norm_21apr2002.sav'
;save, danb, filename='danb_21apr2002.sav'
...
pmm, diffn, mm=mm
for i=0,sz[2]-2 do begin
	diffnb(*,*,i) = bytscl( diffn(*,*,i), mm[0], mm[1])
endfor
