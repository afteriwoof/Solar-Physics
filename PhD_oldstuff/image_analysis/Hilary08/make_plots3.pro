...
pro make_plots3
	...
	wset, 0
	pos = [0, 0.8, 0.2, 1]
	front_ell_kinematics_printout_chose3, edges[*,*,k], errorsc2[k], in[k], da[*,*,k], 2, pos
	;**********
	...
	wset, 0
	pos = [0.2, 0.8, 0.4, 1]
	front_ell_kinematics_printout_chose3, edges[*,*,k+2], errorsc3[k], in[k], da[*,*,k], 2, pos
	;***********
	...
	;*****
        ...
        wset, 0
        pos = [0.2, 0.6, 0.4, 0.8]
        front_ell_kinematics_printout_chose3, edges[*,*,k], errorsc3[k], in[k], da[*,*,k], 2, pos
