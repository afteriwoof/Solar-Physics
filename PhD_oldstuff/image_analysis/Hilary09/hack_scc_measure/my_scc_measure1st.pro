...
;  the color table.
;
common my_scc_measure1st, ahead, h_ahead, behind, h_behind, wcs_ahead, wcs_behind, $
...
;==============================================================================
;
pro my_scc_measure1st, file_ahead, file_behind, index_ahead, index_behind, $
