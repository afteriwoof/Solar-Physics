pro test2, a,b,c,d,e,f,g,h,j,k,l,m,n,im1,im2,im3,im4,im5,im6,im7,im8,im9,im10,im11,im12,im13,x1,y1,x2,y2,x3,y3,x4_1,y4_1,x4_2,y4_2,x5,y5,x6,y6,x7,y7,x8,y8,x9,y9,x10,y10,x11_1,y11_1,x11_2,y11_2,x12_1,y12_1,x12_2,y12_2,x13,y13

;Makes plots of images, saves them as jpegs and makes a movie aswell.
...
;First difference image
	...
	im1=smooth(sigdiff1, 5, /ed)
  	...
  	contour, im1, /xstyle, /ystyle, levels=20, path_info=info, $
...
;Second image
    ...
    contour, im2, /xstyle, /ystyle, levels=30, path_info=info, $
	    path_xy=xy, /path_data_coords
...
;Third image
    ...
    contour, im3, /xstyle, /ystyle, levels=25, path_info=info, $
	             path_xy=xy, /path_data_coords
	window, /free;, xs=imagesize[0]*0.5, ys=imagesize[1]*0.5
	;plot_image, im3
...
;Fourth image
	...
	contour, im4, /xstyle, /ystyle, levels=250, path_info=info, $
		             path_xy=xy, /path_data_coords
...
;Fifth image
	...
	contour, im5, /xstyle, /ystyle, levels=-80, path_info=info, $
	             path_xy=xy, /path_data_coords
...
;Sixth Image
	...
	contour, im6, /xstyle, /ystyle, levels=40, path_info=info, $
		path_xy=xy, /path_data_coords
...
;Seventh Image
	...
	contour, im7, /xstyle, /ystyle, levels=40, path_info=info, $
		path_xy=xy, /path_data_coords
...
;Eight Image
	...
	contour, im8, /xstyle, /ystyle, levels=40, path_info=info, $
		path_xy=xy, /path_data_coords
...
;Ninth Image
	...
	contour, im9, /xstyle, /ystyle, levels=170, path_info=info, $
		path_xy=xy, /path_data_coords
