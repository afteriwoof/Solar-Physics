...
;****************************************************
		...
		help, r_inner, r_outer, thr_inner, thr_outer, r_sun
...
;		plots, [r_thresh,r_thresh], [0,0.012]
	...
	; Using idea of scaling the threshold relative to the bkgrd_average intensity drop-off.
		...
		print, max_dropoff, min_dropoff, percent, median_dropoff
	
		help, bkgrd_average, r_thresh	
...
;				modpix0 = im_decomp[xpix, ypix]
;			       	alppix0 = alpgrad[xpix, ypix, 7]
;
;				modpix1 = im_decomp[xpix+1, ypix]
;				alppix1 = alpgrad[xpix+1, ypix, 7]
;
;				modpix2 = im_decomp[xpix-1, ypix]
;				alppix2 = alpgrad[xpix-1, ypix, 7]
;
;				modpix3 = im_decomp[xpix, ypix+1]                                
;				alppix3 = alpgrad[xpix, ypix+1, 7]
;
;				modpix4 = im_decomp[xpix, ypix-1]
;				alppix4 = alpgrad[xpix, ypix-1, 7]
;
;				modpix5 = im_decomp[xpix+1, ypix+1]                                
;				alppix5 = alpgrad[xpix+1, ypix+1, 7]
;				
;				modpix6 = im_decomp[xpix+1, ypix-1]                                
;				alppix6 = alpgrad[xpix+1, ypix-1, 7]
;				
;				modpix7 = im_decomp[xpix-1, ypix+1]                                
;				alppix7 = alpgrad[xpix-1, ypix+1, 7]
;			
;				modpix8 = im_decomp[xpix-1, ypix-1]
;				alppix8 = alpgrad[xpix-1, ypix-1, 7]
;				
;				!p.multi=0	
;		;		plot_image, mult
;				;plots, xpix, ypix, psym=6, color=3
;				
;				;print, modpix0, alppix0, modpix1, alppix1, modpix2, alppix2, $
;		;			modpix3, alppix3, modpix4, alppix4, modpix5, alppix5, $
;		;			modpix6, alppix6, modpix7, alppix7, modpix8, alppix8	
;		
;		;read, 'pix?', ans		
;
;				endif
