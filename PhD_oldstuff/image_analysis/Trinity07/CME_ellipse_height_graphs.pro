...
; Last edited 12-04-07


pro CME_ellipse_height_graphs, tangents=tangents, previous=previous, lines=lines
...
print, 'time_sec' & print, time_sec
;print, in.time_d&obs

save, paramz, filename='paramz.sav'
save, height, filename='height.sav'
;save, in.date, filename='time.sav'
