pro ellipse_widths, in, height

restore, 'time_C2+C3.sav'
restore, 'ellipse_widths.sav'

  !p.multi = [ 0, 1, 3 ]
  !p.charsize = 2.

widths = widths * 720. *2. ;(since it's only the semi-major right now!)
  
utplot, timtot[0:10] - timtot[0], widths[0:10], timtot[0], psym=-2, $
	timerange= '18-Apr-2000 ' + ['15:00', '19:30'], /xs, yr=[1e5,1.2e7], /ys, $
	ytitle='Width (km)', title='Ellipse Widths'
