...
pro flatten_plane, file, x,y,z,p1,p2,p3,p4, a, b, c, s, t, angle1, angle2, angle3, angle4, pause=pause, noplot=noplot
...
if ~keyword_set(noplot) then begin
	surface, dist(5), /nodata, /save, xrange=[-7,7], yrange=[-14,8], zrange=[-8,-4], $
	        xstyle=1, ystyle=1, zstyle=1, charsize=2, ax=20,az=0
