...
pro ell_quadrilateral, x, y, semimajor, semiminor, xc, yc, ell
...
if p[4] gt 1.57079 then begin
	print, '***************'
	print, 'Tilt angle detected to be larger than 90 degrees'
	print, 'Adjusting it by 90'
	print, 'tilt: ', p[4]*180./!pi
	p[4] -= 1.57079
	print, 'adjusted tilt: ', p[4]*180./!pi
	pause
endif
