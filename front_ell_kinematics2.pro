; Code to read in the CME front and fit an ellipss, taking out the kinematics, where the front edges are not inverted coming from Matlab.
...
pro front_ell_kinematics2, im, in, da, ang, ell_info, x_ellipse, y_ellipse, p
