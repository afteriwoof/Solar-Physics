...
pro run_automated_new, fls, out_dir, pa_total, gail=gail, stereo=stereo, behind=behind, old_data=old_data, show=show, overwrite=overwrite
...
;in.ycen = in.crpix2
	...
	legend, 'Max CME mask: '+int2str(max_cme_mask), /bottom, /right, charsize=2
