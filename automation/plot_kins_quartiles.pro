...
; CREATED BY JASON P. BYRNE jbyrne@ifa.hawaii.edu
...
if min(pos_angles) le 1 AND max(pos_angles) ge 359 then begin
	...
	;NEED TO FIX THE WAY OF SHIFTING ALL THE INFO ~~~~~~!!!!!!
...
cme_kins = {Event_StartTime:datetimes[0], Event_EndTime:datetimes[n_elements(datetimes)-1], CME_RadialLinVel:(median(v_q1s)), $
