...
pro run_automated_realtime_alert, fl, out_dir, pa_slice, cme_alert, gail=gail, stereo=stereo, behind=behind, old_data=old_data, show=show, overwrite=overwrite
...
score = cme_mask_alert(da, cme_mask_str)
; ALERT?
...
; Email alert
;if cme_alert eq 1 then spawn, 'echo "CORIMP CME Alert '+instr+' '+in.filename+'" | mail -s "CORIMP CME ALERT" jbyrne6+corimp@gmail.com'
