...
\begin{figure}[!t]
\centering
\subfigure{\includegraphics[scale=0.56, trim=10 45 0 75]{images/CorPITA_pulse_211_20100814.eps}}
\subfigure{\includegraphics[scale=0.46, trim=10 15 0 70]{images/plot_kins_wave_20100814_savgol.pdf}}
