...
\begin{figure}[!t]
\centering
\subfigure{\includegraphics[scale=0.7, trim=10 70 0 60]{images/CorPITA_pulse_20100814_evt.eps}}
\subfigure{\includegraphics[scale=0.47, trim=10 0 0 70]{images/plot_kins_wave_20100814_savgol.eps}}
\caption{The Savitzky-Golay filter applied to the automated CorPITA detection and tracking of a coronal wave observed by SDO/AIA on 2010 August 14 (\emph{top image}). The top panel of the lower plot shows the distance-time measurements across the angular range of the coronal wave (indicated by the color bar). The middle and bottom panels show the derived velocity and acceleration profiles, with the median (\emph{solid line}) over-plotted.}
