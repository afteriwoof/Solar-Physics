...
pro plot_different_kins_cadence_fixedpoint, cadence, fixed, no_plot=no_plot, fit_vel=fit_vel, large_range=large_range, af, ac, al, att, a_max,af_fixed_err,ac_fixed_err,al_fixed_err, no_legend=no_legend, plot_fixed_point=plot_fixed_point, tog=tog, no_trunc=no_trunc
