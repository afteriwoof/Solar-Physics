...
;Created: 04-02-2011 from plot_kins_diffcadence_fixedpoint.pro

; Last edited: 

pro plot_kins_diffcadence_fixedpoint_bootstrap, h_noisy_new, cadence1, cadence2, cadence1_end, cadence2_begin, fixed, no_plot=no_plot, fit_vel=fit_vel, large_range=large_range, al, att, a_max,al_fixed_err, no_legend=no_legend, plot_fixed_point=plot_fixed_point, tog=tog, no_trunc=no_trunc
...
; Not using noise_percent since it was set in plot_kins_diffcadence_fixedpoint.pro for saving test.sav restored in bootstrap.pro to feed new noise into here:
h_noisy = h_noisy_new*height_factor
