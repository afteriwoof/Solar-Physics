pro plot_hist_mod, data, x, h, bin=bin, xrange=xrange, yrange=yrange, $
   ...
   xmargin=xmargin, ymargin=ymargin, xtitle=xtitle, ytitle=ytitle, pos=pos
;
;+
;NAME:
;	plot_hist
...
if (keyword_set(oplot)) then begin
	...
	xmargin=xmargin, ymargin=ymargin,pos=pos
end
;
end
