; Created	2012-07-19	from fig_peaked_accel_kins.pro to plot out the kins with various noise levels.


pro peaked_accel_kins, tog=tog
...
; Fixed errorbars: h_noisy_sig = replicate(h_noisy[n_elements(h_noisy)/2.]*(errorbars/100.), n_elements(h_noisy))
...
save, tt, h_noisy, v_lagrangian, a_lagrangian, h_noisy_sig, height_factor, vel_factor, accel_factor, f='sample_kins.sav'
