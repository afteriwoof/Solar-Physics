...
; Last edited: 13-12-10

pro plot_different_kins_cadence_fixed2, cadence, fixed, no_plot=no_plot, fit_vel=fit_vel, large_range=large_range, af, ac, al, att, no_legend=no_legend
