...
pro r_diff_simulation_171_linear, date, time171, f_171_lin, cadence, std_dev_171_lin, mean_x_171_lin, errors
...
; Calculate numerically differentiated data
	...
	d_y_f = sim_dist_171_lin[1:max(n)-1] - sim_dist_171_lin[0:max(n)-2]
...
; Zero a fit to velocity data
    ...
    f_171_v_lin = mpfitexpr(v_lin_fit_171, t_cad[0:max(n)-2], v_171_deriv_lin, h_error, $
...
; Calculate numerically differentiated data
	...
	d_y_f = v_171_deriv_lin[1:max(m)-1] - v_171_deriv_lin[0:max(m)-2]
...
; Zero a fit to acceleration data
    ...
    f_171_a_lin = mpfitexpr(a_lin_fit_171, t_cadence[0:max(m)-2], a_171_deriv_lin, h_error, $
