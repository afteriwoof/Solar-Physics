...
pro f_diff_simulation_195_linear, date, time195, f_195_lin, cadence, std_dev_195_lin, mean_x_195_lin, errors
...
; Calculate numerically differentiated data
	...
	d_y_f = sim_dist_195_lin[2:max(n)-1] - sim_dist_195_lin[1:max(n)-2]
...
; Calculate numerically differentiated data
	...
	d_y_f = v_195_deriv_lin[2:max(m)-1] - v_195_deriv_lin[1:max(m)-2]
