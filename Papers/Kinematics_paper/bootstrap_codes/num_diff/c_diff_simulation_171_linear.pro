...
pro c_diff_simulation_171_linear, date, time171, f_171_lin, cadence, std_dev_171_lin, mean_x_171_lin, errors
...
; Calculate numerically differentiated data
	...
	d_y_f = sim_dist_171_lin[2:max(n)-1] - sim_dist_171_lin[0:max(n)-3]
...
; Calculate numerically differentiated data
	...
	d_y_f = v_171_deriv_lin[2:max(m)-1] - v_171_deriv_lin[0:max(m)-3]
