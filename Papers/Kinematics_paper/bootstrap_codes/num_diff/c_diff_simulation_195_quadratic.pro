...
pro c_diff_simulation_195_quadratic, date, time195, f_195_quad, cadence, std_dev_195_quad, mean_x_195_quad, errors
...
; Constant a fit to velocity data
	...
	res_v_195_fit_quad = f_195_v_quad[0] + f_195_v_quad[1]*t_cad[1:max(n)-2]
