...
pro r_diff_simulation_195_linear, date, time195, f_195_lin, cadence, std_dev_195_lin, mean_x_195_lin, errors
...
; Calculate numerically differentiated data
	...
	d_y_f = sim_dist_195_lin[1:max(n)-1] - sim_dist_195_lin[0:max(n)-2]
...
; Zero a fit to velocity data
    ...
    f_195_v_lin = mpfitexpr(v_lin_fit_195, t_cad[0:max(n)-2], v_195_deriv_lin, h_error, $
...
; Calculate numerically differentiated data
	...
	d_y_f = v_195_deriv_lin[1:max(m)-1] - v_195_deriv_lin[0:max(m)-2]
...
; Zero a fit to acceleration data
    ...
    f_195_a_lin = mpfitexpr(a_lin_fit_195, t_cadence[0:max(m)-2], a_195_deriv_lin, h_error, $
