...
pro simulation_195_quadratic, date, time195, f_195_quad, cadence, std_dev_195_quad, mean_x_195_quad
...
; Use fit parameters as basis for ideal velocity
	...
	v_195_deriv_quad = deriv(t[0:*:cad], sim_dist_195_quad*1000.)
	deltav_195_deriv = derivsig(t[0:*:cad], sim_dist_195_quad*1000., 0.0, (std_dev_195_quad*1000.))
...
; Constant a fit to velocity data
    ...
    f_195_v_quad = mpfitexpr(v_quad_fit_195, t[0:*:cad], v_195_deriv_quad, h_error, $
	...
	res_v_195_fit_quad = f_195_v_quad[0] + f_195_v_quad[1]*t[0:*:cadence]
...
; Plot of velocity
	...
	plot, t[0:*:cad], v_195_deriv_quad, xr = [min(t[0:*:cad]) - 10, max(t[0:*:cad]) + 10], $
	...
	oploterr, t[0:*:cad], v_195_deriv_quad, error_v_195, /nohat, /noconnect, errthick = 2, errcolor = 0

	utplot, t[0:*:cad], v_195_deriv_quad, time195[0], timerange = [time195[0] - 60, max(time195) + 60], $
		ytitle = '!6Velocity [!6kms!U-1!N]', yrange = [0, max(v_195_deriv_quad)+100], $
		background = 1, color = 0, psym = 2, charsize = 2, xstyle = 1, ystyle = 1, thick = 2, $
		title = '195A Quadratic fit Sim. vel. plot ' + num2str(date) + ' , Deriv error = ' + num2str(mean(deltav_195_deriv)) + $
		' , Data spread = ' + num2str(error_v_195_quad)
	uterrplot, t[0:*:cad], v_195_deriv_quad + deltav_195_deriv, v_195_deriv_quad - deltav_195_deriv, $
		thick = 2, color = 0
...
; Plot of acceleration
	...
	a_195_deriv_quad = deriv(t[0:*:cad], v_195_deriv_quad*1000.)
	deltaa_195_deriv = derivsig(t[0:*:cad], v_195_deriv_quad*1000., 0.0, (deltav_195_deriv*1000.))
...
; Constant a fit to acceleration data
    ...
    f_195_a_quad = mpfitexpr(a_quad_fit_195, t[0:*:cad], a_195_deriv_quad, h_error, $
	...
	utplot, t[0:*:cad], a_195_deriv_quad, time195[0], timerange = [time195[0] - 60, max(time195) + 60], $
		ytitle = '!6Acceleration [!6ms!U-2!N]', yrange = [min(a_195_deriv_quad)-100, max(a_195_deriv_quad)+100], $
		background = 1, color = 0, psym = 2, charsize = 2, xstyle = 1, ystyle = 1, thick = 2, $
		title = '195A Quadratic fit Sim. acc. plot ' + num2str(date) + ' , Deriv error = ' + num2str(mean(deltaa_195_deriv)) + $
		' , Data spread = ' + num2str(error_a_195_quad)
	uterrplot, t[0:*:cad], a_195_deriv_quad + deltaa_195_deriv, a_195_deriv_quad - deltaa_195_deriv, $
		thick = 2, color = 0
