; Routine to simulate the statistics of different events and use them to look at the velocities involved

pro wave_sim_velocity, date, iterations, event
...
; Use fit parameters as basis for simulated distance plot. Use gaussian to provide scatter in data

	resolve_routine, 'sim_vel_195_linear'

	sim_vel_195_linear, date, time195, f_195_lin, std_dev_195_lin, dist_arr_195, mean_x_195_lin, iterations
...
; Use fit parameters as basis for simulated distance plot. Use gaussian to provide scatter in data
	...
	resolve_routine, 'sim_vel_195_quadratic'

	sim_vel_195_quadratic, date, time195, f_195_quad, std_dev_195_quad, dist_arr_195, mean_x_195_quad, iterations

	x2png, 'wave_vel_sim_195_' + num2str(date) + '.png'
...
; Use fit parameters as basis for simulated distance plot. Use gaussian to provide scatter in data
	...
	resolve_routine, 'sim_vel_171_linear'

	sim_vel_171_linear, date, time171, f_171_lin, std_dev_171_lin, dist_arr_171, mean_x_171_lin, iterations
...
; Use fit parameters as basis for simulated distance plot. Use gaussian to provide scatter in data
	...
	resolve_routine, 'sim_vel_171_quadratic'

	sim_vel_171_quadratic, date, time171, f_171_quad, std_dev_171_quad, dist_arr_171, mean_x_171_quad, iterations

	x2png, 'wave_vel_sim_171_' + num2str(date) + '.png'
...
; Use fit parameters as basis for simulated distance plot. Use gaussian to provide scatter in data
	...
	resolve_routine, 'sim_acc_195_quadratic'

	sim_acc_195_quadratic, date, time195, f_195_quad, std_dev_195_quad, dist_arr_195, mean_x_195_quad, iterations

; Use fit parameters as basis for simulated distance plot. Use gaussian to provide scatter in data

	resolve_routine, 'sim_acc_171_quadratic'

	sim_acc_171_quadratic, date, time171, f_171_quad, std_dev_171_quad, dist_arr_171, mean_x_171_quad, iterations

	x2png, 'wave_acc_sim_both_' + num2str(date) + '.png'
