...
pro parametric_bootstrapping, date, event, plot_on = plot_on
...
; Restore data
	...
	if (date EQ '20090212') THEN BEGIN
		...
		grt_dist_195 = fltarr(8, 4)
		grt_dist_171 = fltarr(8, 8)
...
; Ensure that any changes in the bootstrapping routines are accounted for
	...
	resolve_routine, 'parametric_bootstrap_lin_195'
	resolve_routine, 'parametric_bootstrap_quad_195'
	resolve_routine, 'parametric_bootstrap_lin_171'
	resolve_routine, 'parametric_bootstrap_quad_171'

	for i = 0, amount do begin

		if (keyword_set(plot_on)) then begin

			parametric_bootstrap_lin_195, date, grt_dist_195[i, *], time195, h_err, dist_arr_195, $
					f_195_lin, perror_195_lin, conf_range_d_195_lin, conf_range_v_195_lin, $
					bootstrap_dist_195_lin, bootstrap_vel_195_lin, /plot_on

			x2png, 'bootstrap_195_plot_lin_' + num2str(date) + '_' + num2str(i) + '.png'

			parametric_bootstrap_quad_195, date, grt_dist_195[i, *], time195, h_err, dist_arr_195, $
					f_195_quad, perror_195_quad, conf_range_d_195_quad, conf_range_v_195_quad, $
					conf_range_a_195_quad, bootstrap_dist_195_quad, bootstrap_vel_195_quad, $
					bootstrap_acc_195_quad, /plot_on

			x2png, 'bootstrap_195_plot_quad_' + num2str(date) + '_' + num2str(i) + '.png'

			parametric_bootstrap_lin_171, date, grt_dist_171[i, *], time171, h_err, dist_arr_171, $
					f_171_lin, perror_171_lin, conf_range_d_171_lin, conf_range_v_171_lin, $
					bootstrap_dist_171_lin, bootstrap_vel_171_lin, /plot_on

			x2png, 'bootstrap_171_plot_lin_' + num2str(date) + '_' + num2str(i) + '.png'

			parametric_bootstrap_quad_171, date, grt_dist_171[i, *], time171, h_err, dist_arr_171, $
					f_171_quad, perror_171_quad, conf_range_d_171_quad, conf_range_v_171_quad, $
					conf_range_a_171_quad, bootstrap_dist_171_quad, bootstrap_vel_171_quad, $
					bootstrap_acc_171_quad, /plot_on

			x2png, 'bootstrap_171_plot_quad_' + num2str(date) + '_' + num2str(i) + '.png'
	
		endif else begin

			parametric_bootstrap_lin_195, date, grt_dist_195[i, *], time195, h_err, dist_arr_195, $
					f_195_lin, perror_195_lin, conf_range_d_195_lin, conf_range_v_195_lin, $
					bootstrap_dist_195_lin, bootstrap_vel_195_lin

			parametric_bootstrap_quad_195, date, grt_dist_195[i, *], time195, h_err, dist_arr_195, $
					f_195_quad, perror_195_quad, conf_range_d_195_quad, conf_range_v_195_quad, $
					conf_range_a_195_quad, bootstrap_dist_195_quad, bootstrap_vel_195_quad, $
					bootstrap_acc_195_quad

			parametric_bootstrap_lin_171, date, grt_dist_171[i, *], time171, h_err, dist_arr_171, $
					f_171_lin, perror_171_lin, conf_range_d_171_lin, conf_range_v_171_lin, $
					bootstrap_dist_171_lin, bootstrap_vel_171_lin

			parametric_bootstrap_quad_171, date, grt_dist_171[i, *], time171, h_err, dist_arr_171, $
					f_171_quad, perror_171_quad, conf_range_d_171_quad, conf_range_v_171_quad, $
					conf_range_a_171_quad, bootstrap_dist_171_quad, bootstrap_vel_171_quad, $
					bootstrap_acc_171_quad

		endelse		
	
		openw, lun, /get_lun, 'parametric_bootstrapping_info' + num2str(date) + '_' + num2str(i) + '.txt', error=err
		free_lun, lun

		openu, lun, 'parametric_bootstrapping_info' + num2str(date) + '_' + num2str(i) + '.txt', /append
		printf, lun, '#Bootstrapping Analysis data for ' + num2str(date) + ' event'
		printf, lun, ' '
		...
		printf, lun, ' '
		printf, lun, '#195 Linear fit bootstrapping equation'
		printf, lun, 'y = ' + num2str(bootstrap_vel_195_lin[0]) + '*x + ' $
			+ num2str(bootstrap_dist_195_lin[0])
		printf, lun, ' '
		Printf, lun, 'R0 = ' + num2str(bootstrap_dist_195_lin[0]) + ' err = ' $
			+ num2str(bootstrap_dist_195_lin[1])
		Printf, lun, 'V0 = ' + num2str(bootstrap_vel_195_lin[0]) + ' err = ' + num2str(bootstrap_vel_195_lin[1])
		printf, lun, ' '
		printf, lun, '#171 Linear fit bootstrapping equation'
		printf, lun, 'y = ' + num2str(bootstrap_vel_171_lin[0]) + '*x + ' $
			+ num2str(bootstrap_dist_171_lin[0])
		printf, lun, ' '
		Printf, lun, 'R0 = ' + num2str(bootstrap_dist_171_lin[0]) + ' err = ' $
			+ num2str(bootstrap_dist_171_lin[1])
		Printf, lun, 'V0 = ' + num2str(bootstrap_vel_171_lin[0]) + ' err = ' + num2str(bootstrap_vel_171_lin[1])
		printf, lun, ' '
		printf, lun, '#195 Quadratic fit bootstrapping equation'
		printf, lun, 'y = (1/2)' + num2str(bootstrap_acc_195_quad[0]) + 'x^2 + ' $
			+ num2str(bootstrap_vel_195_quad[0]) + $
			'*x + ' + num2str(bootstrap_dist_195_quad[0])
		printf, lun, ' '
		Printf, lun, 'R0 = ' + num2str(bootstrap_dist_195_quad[0]) + ' err = ' + num2str(bootstrap_dist_195_quad[1])
		Printf, lun, 'V0 = ' + num2str(bootstrap_vel_195_quad[0]) + ' err = ' + num2str(bootstrap_vel_195_quad[1])
		Printf, lun, 'A0 = ' + num2str(bootstrap_acc_195_quad[0]) + ' err = ' + num2str(bootstrap_acc_195_quad[1])
		printf, lun, ' '
		printf, lun, '#171 Quadratic fit bootstrapping equation'
		printf, lun, 'y = (1/2)' + num2str(bootstrap_acc_171_quad[0]) + 'x^2 + ' $
			+ num2str(bootstrap_vel_171_quad[0]) + $
			'*x + ' + num2str(bootstrap_dist_171_quad[0])
		printf, lun, ' '
		Printf, lun, 'R0 = ' + num2str(bootstrap_dist_171_quad[0]) + ' err = ' + num2str(bootstrap_dist_171_quad[1])
		Printf, lun, 'V0 = ' + num2str(bootstrap_vel_171_quad[0]) + ' err = ' + num2str(bootstrap_vel_171_quad[1])
		Printf, lun, 'A0 = ' + num2str(bootstrap_acc_171_quad[0]) + ' err = ' + num2str(bootstrap_acc_171_quad[1])
		printf, lun, ' '
		printf, lun, '#95% Confidence Interval - Linear fit 195'
		printf, lun, ' '
		printf, lun, 'R0 = ' + arr2str(conf_range_d_195_lin) + ' Mm'
		printf, lun, 'V0 = ' + arr2str(1000*conf_range_v_195_lin) + ' km/s'
		printf, lun, ' '
		printf, lun, '#95% Confidence Interval - Quadratic fit 195'
		printf, lun, ' '
		printf, lun, 'R0 = ' + arr2str(conf_range_d_195_quad) + ' Mm'
		printf, lun, 'V0 = ' + arr2str(1000*conf_range_v_195_quad) + ' km/s'
		printf, lun, 'A0 = ' + arr2str(1e6*conf_range_a_195_quad) + ' m/s/s'
		printf, lun, ' '
		printf, lun, '#95% Confidence Interval - Linear fit 171'
		printf, lun, ' '
		printf, lun, 'R0 = ' + arr2str(conf_range_d_171_lin) + ' Mm'
		printf, lun, 'V0 = ' + arr2str(1000*conf_range_v_171_lin) + ' km/s'
		printf, lun, ' '
		printf, lun, '#95% Confidence Interval - Quadratic fit 171'
		printf, lun, ' '
		printf, lun, 'R0 = ' + arr2str(conf_range_d_171_quad) + ' Mm'
		printf, lun, 'V0 = ' + arr2str(1000*conf_range_v_171_quad) + ' km/s'
