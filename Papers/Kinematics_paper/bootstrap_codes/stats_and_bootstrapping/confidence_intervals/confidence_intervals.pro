...
; Restore confidence interval data - R0 195 Lin
	...
	plot, [conf_range_r_195_lin[0], conf_range_r_195_lin[1]], [0, 0], color = 0, background = 1, $
		yr = [-1, 7], /ys, xr = [50, 300], /xs, charsize = 2, title = 'R0 195 Linear - 95% Confidence intervals', $
	...
	oplot, [conf_range_r_195_lin[0], conf_range_r_195_lin[1]], [6, 6], color = 3
...
; Restore confidence interval data - V0 195 Lin
	...
	plot, [1e3*(conf_range_v_195_lin[0]), 1e3*(conf_range_v_195_lin[1])], [0, 0], color = 0, background = 1, $
		yr = [-1, 7], /ys, charsize = 2, title = 'V0 195 Linear - 95% Confidence intervals', $
	...
	restore, 'CI_' + num2str(date) + '_average.sav'
	oplot, [1e3*(conf_range_v_195_lin[0]), 1e3*(conf_range_v_195_lin[1])], [6, 6], color = 3

	legend, ['Arc-lines', 'Averaged Arcs'], textcolor = [0, 3], /clear, charsize = 1.5, outline_color = 0

	x2png, 'confidence_interval_195_lin_20070519.png'
...
; Restore confidence interval data - R0 195 Quad
	...
	plot, [conf_range_r_195_quad[0], conf_range_r_195_quad[1]], [0, 0], color = 0, background = 1, $
		yr = [-1, 7], /ys, xr = [50, 300], /xs, charsize = 2, title = 'R0 195 Quadratic - 95% Confidence intervals', $
		ytitle = 'Arc-line number', xtitle = 'R0 (Mm)'
	...
	restore, 'CI_' + num2str(date) + '_average.sav'
	oplot, [conf_range_r_195_quad[0], conf_range_r_195_quad[1]], [6, 6], color = 3
...
; Restore confidence interval data - V0 195 Quad
	...
	plot, [1e3*(conf_range_v_195_quad[0]), 1e3*(conf_range_v_195_quad[1])], [0, 0], color = 0, background = 1, $
		yr = [-1, 7], /ys, charsize = 2, title = 'V0 195 Quadratic - 95% Confidence intervals', $
		ytitle = 'Arc-line number', xtitle = 'V0 (km/s)'
	...
	restore, 'CI_' + num2str(date) + '_average.sav'
	oplot, [1e3*(conf_range_v_195_quad[0]), 1e3*(conf_range_v_195_quad[1])], [6, 6], color = 3
...
; Restore confidence interval data - A0 195 Quad
	...
	plot, [1e6*(conf_range_a_195_quad[0]), 1e6*(conf_range_a_195_quad[1])], [0, 0], color = 0, background = 1, $
		yr = [-1, 7], /ys, charsize = 2, title = 'A0 195 Quadratic - 95% Confidence intervals', $
	...
	restore, 'CI_' + num2str(date) + '_average.sav'
	oplot, [1e6*(conf_range_a_195_quad[0]), 1e6*(conf_range_a_195_quad[1])], [6, 6], color = 3
	
	legend, ['Arc-lines', 'Averaged Arcs'], textcolor = [0, 3], /clear, charsize = 1.5, outline_color = 0

	x2png, 'confidence_interval_195_quad_20070519.png'
...
; Restore confidence interval data - R0 171 Lin
	...
	plot, [conf_range_r_171_lin[0], conf_range_r_171_lin[1]], [0, 0], color = 0, background = 1, $
		yr = [-1, 7], /ys, xr = [100, 200], /xs, charsize = 2, title = 'R0 171 Linear - 95% Confidence intervals', $
		ytitle = 'Arc-line number', xtitle = 'R0 (Mm)'
	...
	restore, 'CI_' + num2str(date) + '_average.sav'
	oplot, [conf_range_r_171_lin[0], conf_range_r_171_lin[1]], [6, 6], color = 3
...
; Restore confidence interval data - V0 171 Lin
	...
	plot, [1e3*(conf_range_v_171_lin[0]), 1e3*(conf_range_v_171_lin[1])], [0, 0], color = 0, background = 1, $
		yr = [-1, 7], /ys, xr = [300, 700], /xs, charsize = 2, title = 'V0 171 Linear - 95% Confidence intervals', $
		ytitle = 'Arc-line number', xtitle = 'V0 (km/s)'
	...
	restore, 'CI_' + num2str(date) + '_average.sav'
	oplot, [1e3*(conf_range_v_171_lin[0]), 1e3*(conf_range_v_171_lin[1])], [6, 6], color = 3
	
	legend, ['Arc-lines', 'Averaged Arcs'], textcolor = [0, 3], /clear, charsize = 1.5, outline_color = 0

	x2png, 'confidence_interval_171_lin_20070519.png'
...
; Restore confidence interval data - R0 171 Quad
	...
	plot, [conf_range_r_171_quad[0], conf_range_r_171_quad[1]], [0, 0], color = 0, background = 1, $
		yr = [-1, 7], /ys, xr = [100, 200], /xs, charsize = 2, title = 'R0 171 Quadratic - 95% Confidence intervals', $
		ytitle = 'Arc-line number', xtitle = 'R0 (Mm)'
	...
	restore, 'CI_' + num2str(date) + '_average.sav'
	oplot, [conf_range_r_171_quad[0], conf_range_r_171_quad[1]], [6, 6], color = 3
...
; Restore confidence interval data - V0 171 Quad
	...
	plot, [1e3*(conf_range_v_171_quad[0]), 1e3*(conf_range_v_171_quad[1])], [0, 0], color = 0, background = 1, $
		yr = [-1, 7], /ys, xr = [300, 700], /xs, charsize = 2, title = 'V0 171 Quadratic - 95% Confidence intervals', $
		ytitle = 'Arc-line number', xtitle = 'V0 (km/s)'
	...
	restore, 'CI_' + num2str(date) + '_average.sav'
	oplot, [1e3*(conf_range_v_171_quad[0]), 1e3*(conf_range_v_171_quad[1])], [6, 6], color = 3
...
; Restore confidence interval data - A0 171 Quad
	...
	plot, [1e6*(conf_range_a_171_quad[0]), 1e6*(conf_range_a_171_quad[1])], [0, 0], color = 0, background = 1, $
		yr = [-1, 7], /ys, xr = [-500, 500], /xs, charsize = 2, title = 'A0 171 Quadratic - 95% Confidence intervals', $
		ytitle = 'Arc-line number', xtitle = 'A0 (m/s/s)'
	...
	restore, 'CI_' + num2str(date) + '_average.sav'
	oplot, [1e6*(conf_range_a_171_quad[0]), 1e6*(conf_range_a_171_quad[1])], [6, 6], color = 3
	
	legend, ['Arc-lines', 'Averaged Arcs'], textcolor = [0, 3], /clear, charsize = 1.5, outline_color = 0

	x2png, 'confidence_interval_171_quad_20070519.png'
