...
pro simulated_images_reverse, date, cadence
...
; Images
	...
	toggle, /portrait, filename = 'stats_sim_r_1.eps', xsize = 6, ysize = 6, /inches, /color, bits_per_pixel = 8
...
; Calculate numerically differentiated data
	...
	d_y_f_e = v_195_deriv_quad[1:max(m)-1] - v_195_deriv_quad[0:max(m)-2]

	d_x_f_e = t_cadence[1:max(m)-1] - t_cadence[0:max(m)-2]
...
; Plot of velocity
	...
	utplot, t_cad[0:max(n)-2], v_195_deriv_quad, time195[0], timerange = [time195[0] - 60, max(time195) + 60], $
	...
	uterrplot, t_cad[0:max(n)-2], v_195_deriv_quad + mean(deltav_195_deriv), v_195_deriv_quad - mean(deltav_195_deriv), $
		thick = 2, color = 0
...
; Calculate numerically differentiated data
	...
	d_y_f_e = a_195_deriv_quad[1:max(c)-1] - a_195_deriv_quad[0:max(c)-2]

	d_x_f_e = t_cad[1:max(c)-1] - t_cad[0:max(c)-2]
...
; Constant a fit to acceleration data
	...
	utplot, t_cadence[0:max(m)-2], a_195_deriv_quad, time195[0], timerange = [time195[0] - 60, max(time195) + 60], $
		ytitle = '!6Acceleration [!6ms!U-2!N]', yrange = [min(a_195_deriv_quad)-100, max(a_195_deriv_quad)+100], $
		background = 1, color = 0, psym = 2, charsize = 1, xstyle = 1, ystyle = 1, thick = 2, $
		pos = [0.15, 0.1, 0.95, 0.37]
	uterrplot, t_cadence[0:max(m)-2], a_195_deriv_quad + mean(deltaa_195_deriv), a_195_deriv_quad - mean(deltaa_195_deriv), $
		thick = 2, color = 0
...
; Images
	...
	toggle, /portrait, filename = 'stats_sim_r_2.eps', xsize = 6, ysize = 6, /inches, /color, bits_per_pixel = 8
...
; Calculate numerically differentiated data
	...
	d_y_f_e = v_171_deriv_quad[1:max(m)-1] - v_171_deriv_quad[0:max(m)-2]
...
; Plot of velocity
	...
	utplot, t_cad[0:max(n)-2], v_171_deriv_quad, time171[0], timerange = [time171[0] - 60, max(time171) + 60], $
		ytitle = '!6Velocity [!6kms!U-1!N]', yrange = [min(v_171_deriv_quad)-100, max(v_171_deriv_quad)+100], $
		background = 1, color = 0, psym = 2, charsize = 1, xstyle = 1, ystyle = 1, thick = 2, $
		xtitle = ' ', xtickname = [' ',' ',' ',' ',' ',' '], pos = [0.15, 0.39, 0.95, 0.66]
	uterrplot, t_cad[0:max(n)-2], v_171_deriv_quad + mean(deltav_171_deriv), v_171_deriv_quad - mean(deltav_171_deriv), $
		thick = 2, color = 0
...
; Calculate numerically differentiated data
	...
	d_y_f_e = a_171_deriv_quad[1:max(c)-1] - a_171_deriv_quad[0:max(c)-2]
...
; Constant a fit to acceleration data
	...
	utplot, t_cadence[0:max(m)-2], a_171_deriv_quad, time171[0], timerange = [time171[0] - 60, max(time171) + 60], $
		ytitle = '!6Acceleration [!6ms!U-2!N]', yrange = [min(a_171_deriv_quad)-100, max(a_171_deriv_quad)+100], $
		background = 1, color = 0, psym = 2, charsize = 1, xstyle = 1, ystyle = 1, thick = 2, $
		pos = [0.15, 0.1, 0.95, 0.37]
	uterrplot, t_cadence[0:max(m)-2], a_171_deriv_quad + mean(deltaa_171_deriv), a_171_deriv_quad - mean(deltaa_171_deriv), $
		thick = 2, color = 0
