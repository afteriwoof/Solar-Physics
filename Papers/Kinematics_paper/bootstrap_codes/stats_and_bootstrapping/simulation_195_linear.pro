...
pro simulation_195_linear, date, time195, f_195_lin, cadence, std_dev_195_lin, mean_x_195_lin
...
; Use fit parameters as basis for ideal velocity
	...
	v_195_deriv_lin = deriv(t[0:*:cad], sim_dist_195_lin*1000.)
	deltav_195_deriv = derivsig(t[0:*:cad], sim_dist_195_lin*1000., 0.0, (std_dev_195_lin*1000.))
...
; Zero a fit to velocity data
    ...
    f_195_v_lin = mpfitexpr(v_lin_fit_195, t[0:*:cad], v_195_deriv_lin, h_error, $
...
; Plot of velocity
	...
	oploterr, t[0:*:cad], v_195_deriv_lin, deltav_195_deriv, /nohat, /noconnect, errthick = 2, errcolor = 0
...
; Use fit parameters as basis for ideal acceleration
	...
	a_195_deriv_lin = deriv(t[0:*:cad], v_195_deriv_lin*1000.)
	deltaa_195_deriv = derivsig(t[0:*:cad], v_195_deriv_lin*1000., 0.0, (deltav_195_deriv*1000.))
...
; Zero a fit to acceleration data
    ...
    f_195_a_lin = mpfitexpr(a_lin_fit_195, t[0:*:cad], a_195_deriv_lin, h_error, $
	...
	res_a_195_fit_lin = replicate(f_195_a_lin[0], n)
...
; Plot of acceleration
	...
	plot, t[0:*:cad], a_195_deriv_lin, xr = [min(t[0:*:cad]) - 10, max(t[0:*:cad]) + 10], $
	...
	oploterr, t[0:*:cad], a_195_deriv_lin, deltaa_195_deriv, /nohat, /noconnect, errthick = 2, errcolor = 0
