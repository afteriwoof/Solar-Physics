...
; Last edited:	2013-05-01	to ensure the bootstrap is correct, in the adding of the residuals to the initial fit.
	...
	for j=0,iters-1 do begin
		if j eq 0 then begin
			utplot, tt, h_noisy[j,*]/height_factor, utbase, psym=3, color=3, pos=pos_h, xtickname=[' ',' ',' ',' ',' ',' ',' ',' '], $
				yr=yr_h, ystyle=8, ytit='Height (Mm)', xtit=' ', tit='Bootstrap : '+title, xr=[tt[0]-xls,tt[*]+xrs],/xs;, /ylog
