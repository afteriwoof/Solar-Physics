...
for i = 0, 40 do begin
  ...
  legend, [ 'Theory', 'Simulation', 'Smoothed Simulation' ], line = [ 0, 2, 4], charsize = 1.5

  v_smooth_obs = deriv( t, smooth((h_obs), 3, /edge) )
  v_obs = deriv( t, h_obs )
  v_theory = v0 + a0 * t
  ...
  oplot, t, v_theory 
  oplot, t, v_smooth_obs, psym = -4, line = 4
  oplot_err, t, v_obs, yerr = sig_v_obs
 
  a_obs = deriv( t, v_obs )
  a_smooth_obs = deriv( t, smooth((v_smooth_obs), 3, /edge) )
  ...
  oplot, t, a_theory
  oplot, t, a_smooth_obs, psym = -4, line = 4
