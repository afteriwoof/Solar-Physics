...
\end{eqnarray}
The velocity at point $x$ is given by $L'(x)=\partial_x L(x)$. In the case of equal spacing between the points, the 3-point Lagrangian gives the same result as the centre differencing technique (without removing the endpoints).
%\begin{eqnarray}
