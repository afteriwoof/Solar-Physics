...
\begin{figure}[t]
\centering{\includegraphics[clip=true, scale=0.265, trim=0 0 0 0]{images/lasco_kins_temp.pdf}}
\caption{LASCO/C2 and C3 observations of the CME with ellipse-fits to the core, BUT the kinematics of the CME front here.}
\label{lasco_kins_temp}
\end{figure}
