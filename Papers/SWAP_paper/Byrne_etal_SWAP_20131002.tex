...
\begin{figure}[t]
\centering{\includegraphics[clip=true, scale=0.4, trim=0 0 0 0]{images/lasco_c2_fig.eps}}
\caption{The CME as observed with LASCO/C2, and the ellipse-fit to the characterized core material.}
\label{lasco_c2_fig}
\end{figure}
