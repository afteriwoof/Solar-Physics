...
\title{Investigating the `double-expansion' of the 2011-03-08 eruption}
...
\begin{figure*}
\centering
\subfigure{\includegraphics[scale=0.3, clip=true, trim=60 0 0 0]{images/combined.eps}}
\label{front_mults}
\subfigure{\includegraphics[scale=0.3, clip=true, trim=0 65 110 90]{images/ells_fig.eps}}
\label{ell_front}
