...
;  window, xsize = 600, ysize = 800
  ...
  plot, t, v_obs, psym = -2, xtit = 'Time (s)', ytit = 'Velocity (km s!U-1!N)', yr = [ 0, max( v_theory ) * 1.2 ], line = 2, xr = xr, /xs
  oplot, t, v_theory 
  ...
  plot, t, a_obs, psym = -2, xtit = 'Time (s)', ytit = 'Acceleration (m s!U-2!N)', yr = [ -20, 20 ], line = 2, xr = xr, /xs, /ys
  oplot, t, a_theory
