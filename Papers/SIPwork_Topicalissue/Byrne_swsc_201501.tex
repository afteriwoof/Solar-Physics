...
\begin{linenumbers}
   ...
   \titlerunning{Investigating CORIMP}

   \authorrunning{Byrne et al.}

   \author{J. P. Byrne\inst{1,2}}%, H. Morgan$^{3,4}$,  P. T. Gallagher$^{5}$, S. R. Habbal$^{2}$}
          %\and
...
%\begin{figure}[!h]
%\centerline{\includegraphics[width=\linewidth, trim=0 250 0 0]{images/plot_kins_quartiles_linear_20000418_152817.pdf}}
