; Created	2013-06-14	from plot_kins_wave_paperfig.pro
...
datetime = anytim(datetimes_in,/ccsds)
heights = heights_in
...
utplot, t, (new_heights*height_fac), utbasedata, psym=1, ytit='Distance (Mm)', pos=[0.15,0.63,0.92,0.91],yr=[0,h_max_range],ystyle=8, $
...
if keyword_set(plot_quartiles) then begin
	...
	outplot, t_bins, v_q1s*vel_fac, utbasedata, psym=-3, thick=thick_t, color=c, line=1
	outplot, t_bins, v_q3s*vel_fac, utbasedata, psym=-3, thick=thick_t, color=c, line=1
	outplot, t_bins, lowerfence*vel_fac, utbasedata, psym=-3, thick=thick_t, color=c, line=1
	outplot, t_bins, upperfence*vel_fac, utbasedata, psym=-3, thick=thick_t, color=c, line=1
...
if keyword_set(plot_quartiles) then begin
	...
	outplot, t_bins, a_q1s*accel_fac, utbasedata, psym=-3, thick=thick_t, color=c, line=1
	outplot, t_bins, a_q3s*accel_fac, utbasedata, psym=-3, thick=thick_t, color=c, line=1
	outplot, t_bins, lowerfence*accel_fac, utbasedata, psym=-3, thick=thick_t, color=c, line=1
	outplot, t_bins, upperfence*accel_fac, utbasedata, psym=-3, thick=thick_t, color=c, line=1
