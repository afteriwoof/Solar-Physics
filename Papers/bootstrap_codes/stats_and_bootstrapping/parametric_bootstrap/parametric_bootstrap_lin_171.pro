...
pro parametric_bootstrap_lin_171, date, grt_dist_171, time171, h_err, dist_arr_171, f_171_lin, $
...
; Fitted equation that we wish to test.
	...
	if (keyword_set(plot_on)) then begin
		...
		data_fit_171_linear, grt_dist_171, time171, h_err, dist_arr_171, f_171_lin, perror, /plot_on
...
; Plot trend line and standard deviation margin
	...
	if (keyword_set(plot_on)) then begin
		...
		legend, ['R0 = ' + num2str(f_171_lin[0]) + ' +/- ' + num2str(perror[0]) + ' Mm', $
				'V0 = ' + num2str(1000*f_171_lin[1]) + ' +/- ' + num2str(1000*perror[1]) + ' km/s'], $
...
; of fit to original data
		...
		dist_arr = RANDOMN( Seed1, dist_arr_171, /DOUBLE, /NORMAL )*perror[0] + f_171_lin[0]
...
; of fit to original data
		...
		vel_arr = RANDOMN( Seed2, dist_arr_171, /DOUBLE, /NORMAL )*perror[1] + f_171_lin[1]
