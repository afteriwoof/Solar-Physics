...
pro model_tester_20090715, date
...
; 195A data - linear
	...
	great_dist_195 = grt_dist_195[2, *]
	
	arr_size = size(great_dist_195, /n_elements)
	
	grt_dist_195 = fltarr(arr_size)
	
	for i = 0, arr_size-1 do begin
	
		grt_dist_195[i] = great_dist_195[i]
		
	endfor
	
	grt_dist_195 = [0, grt_dist_195]		
...
; Add varying time value to start of time array
	...
	for t = 0, cad, cad/100. do begin
		...
		tim195 = [time195[0] - time195[0] - t, time195 - time195[0] + t]
