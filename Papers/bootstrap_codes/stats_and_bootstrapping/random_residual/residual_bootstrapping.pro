...
pro residual_bootstrapping, date, event_num, plot_on = plot_on
...
; Restore data
	...
	if (date EQ '20070806') THEN BEGIN
		if (event_num EQ '1') THEN BEGIN
			...
			grt_dist_195 = fltarr(11, 4)
			grt_dist_171 = fltarr(11, 6)
		...
		if (event_num EQ '2') THEN BEGIN
			...
			grt_dist_195 = fltarr(12, 4)
			grt_dist_171 = fltarr(12, 4)
...
;	for i = 5, 5 do begin
		...
		resample_residual_195_lin, date, grt_dist_195[i, *], time195, h_err, dist_arr_195, $
				f_195_lin, perror_195_lin, p1_195_lin, s1_195_lin, p2_195_lin, s2_195_lin, $
				conf_range_r_195_lin, conf_range_v_195_lin

		if (date EQ '20070806') then begin 
			x2png, 'resampled_residuals_195_lin_' + num2str(date) + '_' + num2str(event_num) + '_' + num2str(i) + '.png'
		endif else begin
			x2png, 'resampled_residuals_195_lin_' + num2str(date) + '_' + num2str(i) + '.png'
		endelse
	
		resample_residual_195_quad, date, grt_dist_195[i, *], time195, h_err, dist_arr_195, $
		...
		if (date EQ '20070806') then begin 
			x2png, 'resampled_residuals_195_quad_' + num2str(date) + '_' + num2str(event_num) + '_' + num2str(i) + '.png'
		endif else begin
			x2png, 'resampled_residuals_195_quad_' + num2str(date) + '_' + num2str(i) + '.png'
		endelse

		resample_residual_171_lin, date, grt_dist_171[i, *], time171, h_err, dist_arr_171, $
				f_171_lin, perror_171_lin, p1_171_lin, s1_171_lin, p2_171_lin, s2_171_lin, $
				conf_range_r_171_lin, conf_range_v_171_lin

		if (date EQ '20070806') then begin 
			x2png, 'resampled_residuals_171_lin_' + num2str(date) + '_' + num2str(event_num) + '_' + num2str(i) + '.png'
		endif else begin
			x2png, 'resampled_residuals_171_lin_' + num2str(date) + '_' + num2str(i) + '.png'
		endelse

		resample_residual_171_quad, date, grt_dist_171[i, *], time171, h_err, dist_arr_171, $
		...
		if (date EQ '20070806') then begin 
			x2png, 'resampled_residuals_171_quad_' + num2str(date) + '_' + num2str(event_num) + '_' + num2str(i) + '.png'
		endif else begin
			x2png, 'resampled_residuals_171_quad_' + num2str(date) + '_' + num2str(i) + '.png'
		endelse

; Text file
	
		if (date EQ '20070806') then begin 
			openw, lun, /get_lun, 'residual_resampling_info' + num2str(date) + '_' + $
				num2str(event_num) + '_' + num2str(i) + '.txt', error=err
		endif else begin
			openw, lun, /get_lun, 'residual_resampling_info' + num2str(date) + '_' + num2str(i) + '.txt', error=err
		endelse

		free_lun, lun

		if (date EQ '20070806') then begin 
			openu, lun, 'residual_resampling_info' + num2str(date) + '_' + $
				num2str(event_num) + '_' + num2str(i) + '.txt', /append
		endif else begin
			openu, lun, 'residual_resampling_info' + num2str(date) + '_' + num2str(i) + '.txt', /append
		endelse
		...
		printf, lun, ' '
		Printf, lun, 'R0 = ' + num2str(p1_195_quad[0]) + ' err = ' + num2str(s1_195_quad)
		Printf, lun, 'V0 = ' + num2str(p2_195_quad[0]) + ' err = ' + num2str(s2_195_quad)
		Printf, lun, 'A0 = ' + num2str(p3_195_quad[0]) + ' err = ' + num2str(s3_195_quad)
		printf, lun, ' '
		...
		printf, lun, ' '
		Printf, lun, 'R0 = ' + num2str(p1_171_quad[0]) + ' err = ' + num2str(s1_171_quad)
		Printf, lun, 'V0 = ' + num2str(p2_171_quad[0]) + ' err = ' + num2str(s2_171_quad)
		Printf, lun, 'A0 = ' + num2str(p3_171_quad[0]) + ' err = ' + num2str(s3_171_quad)
		printf, lun, ' '
		...
		if (date EQ '20070806') THEN BEGIN
			...
			save, filename = 'CI_' + num2str(date) + '_' + num2str(event_num) + '_' + num2str(i) + '.sav', $
				conf_range_r_195_lin, conf_range_v_195_lin, conf_range_r_195_quad, conf_range_v_195_quad, $
				conf_range_a_195_quad, conf_range_r_171_lin, conf_range_v_171_lin, conf_range_r_171_quad, $
				conf_range_v_171_quad, conf_range_a_171_quad

		endif else begin
	
			save, filename = 'CI_' + num2str(date) + '_' + num2str(i) + '.sav', conf_range_r_195_lin, $
