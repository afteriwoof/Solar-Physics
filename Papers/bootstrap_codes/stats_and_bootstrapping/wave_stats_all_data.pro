; Wave statistics code designed to use data from all measured events for analysis


pro wave_stats_all_data
	...
	help, residuals_195_lin_20070516
	help, residuals_195_quad_20070516
	help, residuals_171_lin_20070516
	help, residuals_171_quad_20070516
	...
	help, residuals_195_lin_20070519
	help, residuals_195_quad_20070519
	help, residuals_171_lin_20070519
	help, residuals_171_quad_20070519
	...
	help, residuals_195_lin_20070806_1
	help, residuals_195_quad_20070806_1
	help, residuals_171_lin_20070806_1
	help, residuals_171_quad_20070806_1
	...
	help, residuals_195_lin_20070806_2
	help, residuals_195_quad_20070806_2
	help, residuals_171_lin_20070806_2
	help, residuals_171_quad_20070806_2
	...
	help, residuals_195_lin_20071207
	help, residuals_195_quad_20071207
	help, residuals_171_lin_20071207
	help, residuals_171_quad_20071207
	...
	help, residuals_195_lin_20080107
	help, residuals_195_quad_20080107
	help, residuals_171_lin_20080107
	help, residuals_171_quad_20080107
	...
	help, residuals_195_lin_20080426
	help, residuals_195_quad_20080426
	help, residuals_171_lin_20080426
	help, residuals_171_quad_20080426
	
	resolve_routine, 'wave_stats_20090212'
	
	wave_stats_20090212, tim195_20090212, tim171_20090212, residuals_195_lin_20090212, residuals_195_quad_20090212, $
			residuals_171_lin_20090212, residuals_171_quad_20090212

	help, residuals_195_lin_20090212
	help, residuals_195_quad_20090212
	help, residuals_171_lin_20090212
	help, residuals_171_quad_20090212
...
; Make arrays of residuals and time			
	...
	residuals_195_lin = [residuals_195_lin_20070516, residuals_195_lin_20070519, residuals_195_lin_20070806_1, $
			...
			residuals_195_lin_20080426, residuals_195_lin_20090212]
	...
	residuals_195_quad = [residuals_195_quad_20070516, residuals_195_quad_20070519, residuals_195_quad_20070806_1, $
			...
			residuals_195_quad_20080426, residuals_195_quad_20090212]
	...
	residuals_171_lin = [residuals_171_lin_20070516, residuals_171_lin_20070519, residuals_171_lin_20070806_1, $
			...
			residuals_171_lin_20080426, residuals_171_lin_20090212]
...
; Built-in check for standard deviation
	...
	plot, time_195, residuals_195_lin, xr = [min(time_195) - 100, max(time_195) + 100], /xs, psym = 2, $
			...
			' Sample size = ' + num2str(arr_195_lin)
...
; Plot of Probability Distribution function with same mean and standard deviation as data
	...
	oplot, [mean_x_195_lin + std_dev_195_lin, mean_x_195_lin + std_dev_195_lin], [0, gaussian_std_dev], $
		linestyle = 2, thick = 2, color = 0
	oplot, [mean_x_195_lin - std_dev_195_lin, mean_x_195_lin - std_dev_195_lin], [0, gaussian_std_dev], $
		linestyle = 2, thick = 2, color = 0
...
; Built-in check for standard deviation
	...
	plot, time_195, residuals_195_quad, xr = [min(time_195) - 100, max(time_195) + 100], /xs, psym = 2, $
			...
			' Sample size = ' + num2str(arr_195_quad)
...
; Plot of Probability Distribution function with same mean and standard deviation as data
	...
	x2png, 'all_data_195_stats_5.png'
...
; Built-in check for standard deviation
	...
	plot, time_171, residuals_171_lin, xr = [min(time_171) - 100, max(time_171) + 100], /xs, psym = 2, $
			...
			' Sample size = ' + num2str(arr_171_lin)
...
; Plot of Probability Distribution function with same mean and standard deviation as data
	...
	oplot, [mean_x_171_lin + std_dev_171_lin, mean_x_171_lin + std_dev_171_lin], [0, gaussian_std_dev], $
		linestyle = 2, thick = 2, color = 0
	oplot, [mean_x_171_lin - std_dev_171_lin, mean_x_171_lin - std_dev_171_lin], [0, gaussian_std_dev], $
		linestyle = 2, thick = 2, color = 0
...
; Built-in check for standard deviation
	...
	plot, time_171, residuals_171_quad, xr = [min(time_171) - 100, max(time_171) + 100], /xs, psym = 2, $
			...
			' Sample size = ' + num2str(arr_171_quad)
...
; Plot of Probability Distribution function with same mean and standard deviation as data
	...
	x2png, 'all_data_171_stats_5.png'
stop
end
