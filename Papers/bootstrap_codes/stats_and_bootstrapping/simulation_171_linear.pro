...
pro simulation_171_linear, date, time171, f_171_lin, cadence, std_dev_171_lin, mean_x_171_lin
...
; Use fit parameters as basis for ideal velocity
	...
	v_171_deriv_lin = deriv(t[0:*:cad], sim_dist_171_lin*1000.)
	deltav_171_deriv = derivsig(t[0:*:cad], sim_dist_171_lin*1000., 0.0, (std_dev_171_lin*1000.))
...
; Zero a fit to velocity data
    ...
    f_171_v_lin = mpfitexpr(v_lin_fit_171, t[0:*:cad], v_171_deriv_lin, h_error, $
...
; Plot of velocity
	...
	oploterr, t[0:*:cad], v_171_deriv_lin, deltav_171_deriv, /nohat, /noconnect, errthick = 2, errcolor = 0
...
; Use fit parameters as basis for ideal acceleration
	...
	a_171_deriv_lin = deriv(t[0:*:cad], v_171_deriv_lin*1000.)
	deltaa_171_deriv = derivsig(t[0:*:cad], v_171_deriv_lin*1000., 0.0, (deltav_171_deriv*1000.))
...
; Zero a fit to acceleration data
    ...
    f_171_a_lin = mpfitexpr(a_lin_fit_171, t[0:*:cad], a_171_deriv_lin, h_error, $
	...
	res_a_171_fit_lin = replicate(f_171_a_lin[0], n)
...
; Plot of acceleration
	...
	plot, t[0:*:cad], a_171_deriv_lin, xr = [min(t[0:*:cad]) - 10, max(t[0:*:cad]) + 10], $
	...
	oploterr, t[0:*:cad], a_171_deriv_lin, deltaa_171_deriv, /nohat, /noconnect, errthick = 2, errcolor = 0
