...
pro c_diff_simulation_171_quadratic, date, time171, f_171_quad, cadence, std_dev_171_quad, mean_x_171_quad, errors
...
; Constant a fit to velocity data
	...
	res_v_171_fit_quad = f_171_v_quad[0] + f_171_v_quad[1]*t_cad[1:max(n)-2]
