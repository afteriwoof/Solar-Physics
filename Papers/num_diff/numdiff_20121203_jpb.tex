...
\begin{figure}
\centering
\includegraphics[scale=0.5, trim=50 0 0 0]{images/fit_kinscasestudy_CME.eps}
...
\begin{figure}
\centering
\includegraphics[scale=0.5, trim=50 0 0 0]{images/real_wave_data/realdat_kins_20100814_250savgol.eps}
