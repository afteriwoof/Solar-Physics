...
\begin{figure}
\begin{center}
\includegraphics[scale=0.45, trim=20 50 0 255, clip=true]{images/cad_boot_weight_0.eps}
\caption{Histograms showing the initial distance, initial velocity, and acceleration values derived using the bootstrapping technique, for the case of fitting Equation~\ref{eqn:const_a} to the simulated coronal wave measurements with 10\% noise and 300\,s cadence (see top panel of Figure~\ref{cad_hist_weight}).}
...
\begin{figure}[t]
\centering
\subfigure{\includegraphics[scale=0.6, trim=0 80 0 30]{images/fig_bootstrap_quadratic.pdf}}
\subfigure{\includegraphics[scale=0.6, trim=0 20 0 0]{images/fig_residuals_quadratic.pdf}}
\caption{}
\label{fig_quadratic}
\end{figure}
...
\begin{figure}[t]
\centering
\subfigure{\includegraphics[scale=0.6, trim=0 80 0 30]{images/fig_bootstrap_savgol.pdf}}
\subfigure{\includegraphics[scale=0.6, trim=0 20 0 0]{images/fig_residuals_savgol.pdf}}
\caption{}
\label{fig_savgol}
\end{figure}
