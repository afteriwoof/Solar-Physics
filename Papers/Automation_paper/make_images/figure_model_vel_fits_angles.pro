...
pro figure_model_vel_fits_angles, means=means

toggle, /portrait, /color, f='figure_model_vel_fits_angles.ps'
!p.charsize=2
!p.charthick=3
!p.thick=1
...
restore, '~/Postdoc/Automation/Catalogue/multicme_model_dynamic_thr3/detections_noncleaned/redo/v_fit_all1.sav'
restore, '~/Postdoc/Automation/Catalogue/multicme_model_dynamic_thr3/detections_noncleaned/redo/v_fit_angles1.sav'

plot,v_fit_all*1000.,v_fit_angles,psym=1,xr=[0,1000],/xs,yr=[68,110],/ys,pos=[0.63,0.81,1,1], $
	xtickname=[' ',' ',' ',' ',' ',' ']
...
restore, '~/Postdoc/Automation/Catalogue/multicme_model_dynamic_thr3/detections_noncleaned/redo/v_fit_all0.sav'
restore, '~/Postdoc/Automation/Catalogue/multicme_model_dynamic_thr3/detections_noncleaned/redo/v_fit_angles0.sav'

plot,v_fit_all*1000.,v_fit_angles,psym=1,xr=[0,1000],/xs,yr=[240,333],/ys,pos=[0.63,0.61,1,0.8], $
	xtickname=[' ',' ',' ',' ',' ',' ']
...
restore, '~/Postdoc/Automation/Catalogue/multicme_model_dynamic_thr3/detections_noncleaned/redo/v_fit_all3.sav'
restore, '~/Postdoc/Automation/Catalogue/multicme_model_dynamic_thr3/detections_noncleaned/redo/v_fit_angles3.sav'

plot,v_fit_all*1000.,v_fit_angles,psym=1,xr=[0,1000],/xs,yr=[41,60],/ys,pos=[0.63,0.41,1,0.6], $
	xtickname=[' ',' ',' ',' ',' ',' ']
...
restore, '~/Postdoc/Automation/Catalogue/multicme_model_dynamic_thr3/detections_noncleaned/redo/v_fit_all2.sav'
restore, '~/Postdoc/Automation/Catalogue/multicme_model_dynamic_thr3/detections_noncleaned/redo/v_fit_angles2.sav'

plot,v_fit_all*1000.,v_fit_angles,psym=1,xr=[0,1000],/xs,yr=[214,236],/ys,pos=[0.63,0.21,1,0.4], $
	xtickname=[' ',' ',' ',' ',' ',' ']
...
restore, '~/Postdoc/Automation/Catalogue/multicme_model_dynamic_thr3/detections_noncleaned/redo/v_fit_all4.sav'
restore, '~/Postdoc/Automation/Catalogue/multicme_model_dynamic_thr3/detections_noncleaned/redo/v_fit_angles4.sav'

plot,v_fit_all*1000.,v_fit_angles,psym=1,xr=[0,1000],/xs,yr=[216,240],/ys,pos=[0.63,0.01,1,0.2], $
