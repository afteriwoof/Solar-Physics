...
;Created:	15-08-11	to make figures of the automated CME detection on the model.	
...
; size		x:	0-624-200-624		0-624-824-1448
;		y:	0-624			0-624
device, xsize=14.48, ysize=6.24, /cm, /color, filename='figure_model.ps'
...
xyouts, pos[0]+0.02, pos[3]-0.08, '(a)', /norm, charsize=my_charsize, charthick=my_charthick
...
xyouts, pos[0]+0.02, pos[3]-0.08, '(b)', /norm, charsize=my_charsize, charthick=my_charthick
