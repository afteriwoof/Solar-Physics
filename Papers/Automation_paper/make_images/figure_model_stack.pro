...
;Created:	25-08-11	
;Edited:	20120329  to read in the most recent processing files.
...
;restore, '~/Postdoc/Automation/Catalogue/multicme_model_gt0/det_stack*sav'
...
plot_image, pa_total, xtitle='Position Angle (deg.)', ytitle='Time (image no.)', $
...
;	xtitle='Angle (deg.)', ytitle='Time (Image No.)', ytick_get=yticks, $
