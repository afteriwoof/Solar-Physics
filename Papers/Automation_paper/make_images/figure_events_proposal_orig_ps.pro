...
devxs = 2348.
devys = 2886.
device, xsize=devxs/200., ysize=devys/200., bits=8, language=2, /portrait, /cm, /color, filename='figure_events_proposal_orig.ps'
...
fls=file_search('~/Postdoc/Automation/candidates/20000102/cme_sep_fts/*cme.fits.gz')
fls = sort_fls(fls)
...
fls=file_search('~/Postdoc/Automation/candidates/20000418-19/cme_sep_fts/*cme*')
fls = sort_fls(fls)
mreadfits_corimp, fls, in
...
fls=file_search('~/Postdoc/Automation/candidates/20000423/cme_sep_fts/*cme*')
fls = sort_fls(fls)
mreadfits_corimp, fls, in
