...
devxs = 2348.
devys = 2886.
device, xsize=devxs/200., ysize=devys/200., bits=8, language=2, /portrait, /cm, /color, filename='figure_events_proposal.ps'
...
fls=file_search('~/Postdoc/Automation/candidates/20000102/separated/*cme*')
fls = sort_fls(fls)
...
fls=file_search('~/Postdoc/Automation/candidates/lasco_2011/*cme*')
fls = sort_fls(fls)
mreadfits_corimp, fls, in
