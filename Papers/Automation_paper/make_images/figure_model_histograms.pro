...
;Edited:	20120329	to take in the most recently processed files (saved previous version as figure_model_histograms_orig2.pro).

pro figure_model_histograms, means=means, remove_outliers=remove_outliers
...
restore, '~/Postdoc/Automation/Catalogue/multicme_model_gt0/all_h1.sav'

fls_now = fls[image_no[uniq(image_no,sort(image_no))]]
mreadfits_corimp, fls_now, in

t = in.date_obs
utbasedata = anytim(in[0].date_obs)

heights *= (6.955e8/(1000.*ave(in.rsun)))

rsun = 6.955e5

xls = (anytim(t[0]))-utbasedata+20000
xrs = (anytim(t[n_elements(t)-1]))-utbasedata+66000
...
utplot, t, (heights/rsun), utbase, ytit='Height (R!D!9n!N!X)', pos=pos, yr=[0,18.5], $
	xr=[tx1,tx2], /xs, /ys, /nolabel, xtickname=[' ',' ',' ',' ',' ',' ',' '], $
...
for i=min(pos_angles),max(pos_angles) do begin
	...
	if cnt gt 0 then outplot, t[pos_ind], heights[pos_ind]/rsun, symsize=1, thick=2.5, $
...
horline, 5.75, linestyle=1
horline, 6, linestyle=2
horline, 16, linestyle=2

xyouts, 66000, 2.7, 'C2', charsize=0.8
xyouts, 66000, 6.3, 'C3', charsize=0.8
xyouts, 24000, 16.6, 'CME A', charsize=0.8
...
restore, '~/Postdoc/Automation/Catalogue/multicme_model_gt0/all_h0.sav'
...
utplot, t, (heights/rsun), utbase, ytit='Height (R!D!9n!N!X)', pos=pos, yr=[0,18.5], $
        xr=[tx1,tx2], /xs, /ys, /nolabel, xtickname=[' ',' ',' ',' ',' ',' ',' '], /nodata
...
xyouts, 66000, 2.7, 'C2', charsize=0.8
xyouts, 66000, 6.3, 'C3', charsize=0.8
xyouts, 24000, 16.6, 'CME B', charsize=0.8
...
xyouts, 66000, 2.7, 'C2', charsize=0.8
xyouts, 66000, 6.3, 'C3', charsize=0.8
xyouts, 18500, 16.6, 'CMEs D & E', charsize=0.8
...
xyouts, 66000, 2.7, 'C2', charsize=0.8
xyouts, 66000, 6.3, 'C3', charsize=0.8
xyouts, 24000, 16.6, 'CME C', charsize=0.8
...
utplot, t, (heights/rsun), utbase, ytit='Height (R!D!9n!N!X)', pos=pos, yr=[0,18.5], $
        xr=[tx1,tx2], /xs, /ys, /nodata;, /nolabel, xtickname=[' ',' ',' ',' ',' ',' ',' ']
...
xyouts, 66000, 2.7, 'C2', charsize=0.8
xyouts, 66000, 6.3, 'C3', charsize=0.8
xyouts, 24000, 16.6, 'CME F', charsize=0.8
