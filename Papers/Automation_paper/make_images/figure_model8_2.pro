...
devxs = 1800.
devys = 2796.
device, xsize=devxs/175., ysize=devys/175., /encapsul, bits=8, language=2, /portrait, /cm, /color, filename='figure_model8_2.eps'
...
cme_mask[nfov] = 10 ;10 being the max value of pmm of both C2 and C3 cme_masks
