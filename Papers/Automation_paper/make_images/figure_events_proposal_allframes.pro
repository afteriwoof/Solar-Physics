...
fls_C2_1 = file_search('~/postdoc/automation/candidates/20000102/old/*C2.fits.gz')
...
fls_C3_1 = file_search('~/postdoc/automation/candidates/20000102/old/*C3.fits.gz')
...
fls_C2_2 = file_search('~/postdoc/automation/candidates/20000418-19/old/*C2.fits.gz')
...
fls_C3_2 = file_search('~/postdoc/automation/candidates/20000418-19/old/*C3.fits.gz')
...
fls_C2_3 = file_search('~/postdoc/automation/candidates/20000423/old/*C2.fits.gz')
...
fls_C3_3 = file_search('~/postdoc/automation/candidates/20000423/old/*C3.fits.gz')
...
;for frame_count=0,0 do begin
	...
	device, xsize=devxs/200., ysize=devys/200., bits=8, language=2, /encapsul, $
		/portrait, /cm, /color, filename='figure_events_proposal_frame'+int2str(frame_count)+'.eps'
	...
	fls=file_search('~/Postdoc/Automation/candidates/20000102/old/separated/*')
	fls = sort_fls(fls)
	...
	fls=file_search('~/Postdoc/Automation/candidates/20000418-19/old/separated/*fits.gz')
	fls = sort_fls(fls)
	mreadfits_corimp, fls, in
	...
	fls=file_search('~/Postdoc/Automation/candidates/20000423/old/separated/*fits.gz')
	fls = sort_fls(fls)
	mreadfits_corimp, fls, in
