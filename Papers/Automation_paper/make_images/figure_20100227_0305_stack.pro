...
;Created	20120329	from figure_20100312_stack.pro


pro figure_20100227_0305_stack

set_plot, 'ps'

!p.multi=0
;toggle, /color, /landscape, f='figure_20100312_stack.ps'
device, xsize=19, ysize=50, /cm, bits=8, language=2, /portrait, /color, filename='figure_20100227_0305_stack.eps', /encapsul
...
colorbar, pos=[0.38, 0.78, 0.68, 0.79], ncolors=255, minrange=0, maxrange=maxc, /norm, $
