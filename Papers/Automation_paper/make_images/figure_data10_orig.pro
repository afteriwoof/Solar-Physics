...
devxs = 1748.
devys = 3450.
device, xsize=devxs/175., ysize=devys/175., bits=8, language=2, /portrait, /cm, /color, filename='figure_data10_orig.eps', /encapsul
...
set_line_color
arrow, 0.895, 0.852, 0.625, 0.87, /normalized, color=5, thick=my_charthick, hthick=my_charthick
arrow, 0.895, 0.873, 0.784, 0.873, /normalized, color=5, thick=my_charthick, hthick=my_charthick
loadct, 0
...
cme_detectionc2 = readfits_corimp(fls[21])
...
cme_detectionc3 = readfits_corimp(fls[51])
