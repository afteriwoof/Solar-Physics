...
;Created:	17-08-11	to make figures of the automated CME detection on the model, and show data and mask = 6 plots.	
...
device, xs=11.536, ys=13.524, bits=8, language=2, /cm, /color, filename='figure_model6.ps'
