...
\begin{figure*}[!p]
\centerline{\includegraphics[scale=0.85]{figure_data10_latest.eps}}
...
\begin{figure}[!t]
\centerline{\includegraphics[scale=0.78, clip=true, trim=0 0 0 0]{figure_model8.eps}}
