...
\begin{figure*}[!p]
\centerline{\includegraphics[scale=0.85]{images/figure_data10_latest.eps}}
...
\begin{figure*}[!p]
\centerline{\includegraphics[scale=1, clip=true, trim=0 0 0 0]{images/figure_events.eps}}
...
\begin{figure}[!t]
\centerline{\includegraphics[scale=0.78, clip=true, trim=0 0 0 0]{images/figure_model8.eps}}
