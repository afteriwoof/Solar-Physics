...
%\begin{figure}[!t]
%\centerline{\includegraphics[scale=0.42, clip=true, trim=0 70 120 280]{images/figure1.pdf}}
...
%\begin{figure*}[!t]
%\centerline{\includegraphics[scale=0.65, clip=true, trim=0 45 180 95]{images/figure_canny4.pdf}}
...
%\begin{figure*}[!t]
%\centerline{\includegraphics[scale=0.6, clip=true, trim=0 10 190 330]{images/figure_cme_mask.pdf}}
...
%\begin{figure*}[!t]
%\centerline{\includegraphics[angle=0, scale=0.6, clip=true, trim=0 70 80 220]{images/figure_detections.pdf}}
