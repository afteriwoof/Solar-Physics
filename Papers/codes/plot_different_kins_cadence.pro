...
pro plot_different_kins_cadence, cadence, no_plot=no_plot, fit_vel=fit_vel, large_range=large_range, a_forward, a_centre, a_lagrangian
...
help, a
print, n_elements(a)/2
print, a[n_elements(a)/2]
