...
pro kins_curves_and_front

readcol, 'kins.txt', smj, smn, tilt, aw, hc, h, instr, date, time, h_err, delta_t, tilt_err, mag_err, tilt_err_deg, max_h_front, $
	f='F,F,F,F,F,F,A,A,A,F,F,F,F,F,F'
t = anytim(date+' '+time)
utbasedata = t[0]
...
utplot, t, v*km_arc, utbasedata, psym=3, linestyle=1, ytit='!6Velocity (km s!U-1!N)', $
	...
	yr=[0,400], /ys, pos=[0.15,0.38,0.95,0.68];, ytickname=['-500','0','500','1000',' '] 
...
utplot, t, a*km_arc*1000, utbasedata, psym=3, linestyle=1, /notit, ytit='!6Acceleration (m s!U-1!N s!U-1!N)', $
	xr=[t[0]-1000,t[*]+1000], /xs, /ys, yr=[-60,100], pos=[0.15,0.08,0.95,0.38];, ytickname=['-600','-400','-200','0','200','400',' ']
