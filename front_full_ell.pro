...
pro front_full_ell, front, in, da, height_centre, height_apex, aw, ratio, ell_tilt, semimajor, semiminor, ang
	...
	;plot_helio, in.date_obs, roll=in.crota, /over	
	...
	plots, my_xfront, my_yfront, psym=3;, color=8
	x_front = my_xfront
	y_front = my_yfront
