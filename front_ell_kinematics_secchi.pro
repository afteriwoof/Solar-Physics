...
; This code is called by ell_kinematics_secchi.pro which allows an array to be read in together.

; Last Edited: 16-04-08

pro front_ell_kinematics_secchi, im, errs, in, da, ang, ell_info, r_err, x_ellipse, y_ellipse, perror, max_h_front
...
print, in.xcen, in.cdelt1, x_pixel_offset, x_sun_center
print, in.ycen, in.cdelt2, y_pixel_offset, y_sun_center
	;******
...
line_mask[x_sun_center:sz_da[0]-1, y_sun_center] = 1
