; Created:	2013-06-08 from runthru.pro but for the SOHO and STEREO_B.

pro runthru_soho, in_soho, in_stereo, debug=debug, no_pause=no_pause
...
;for k=70,70 do begin & $
	...
	plot_spacecraft_views_soho,in_soho,in_stereo,x,y,z,xe,ye,ze,/zoom & $
	print, slices[k] & $
