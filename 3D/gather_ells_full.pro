...
; Last edited: 20-04-10 from gather_ells.pro to call front_section_full.pro in the 20080426 event.

pro gather_ells_full, fronts=fronts, max_fronts=max_fronts
...
for i=j,k do begin
	...
	if keyword_set(fronts) then begin
		...
		front_section_full, x, y, z, xe, ye, ze, xf, yf, zf
		print, n_elements(xf)
		help, xfs, xf
	...
	; Pull out the coords of the maximum point on the front (furthest from Sun)
		...
		;pause
		;***
	       	;new way to prperly get maximum in 3D
