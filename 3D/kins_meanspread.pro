; code to take out the kinematics at specific angles of flanks, mean and inbetween
...
pro kins_meanspread, fls, hdrs

openw, lun, 'kins_meanspread.txt', /get_lun
...
for k=0,sz[0]-1 do begin
	...
	openu, lun, 'kins_meanspread.txt', /append
