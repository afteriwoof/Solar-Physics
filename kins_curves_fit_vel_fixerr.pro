...
pro kins_curves_fit_vel_fixerr
...
v_err[0]=v_err[0]/2
v_err[n_elements(v_err)-1]=v_err[n_elements(v_err)-1]/2
a_err = derivsig(t,v,delta_t,v_err)
;a_err[0] = a_err[0]/2
;a_err[n_elements(a_err)-1]=a_err[n_elements(a_err)-1]/2
...
utplot, t, a*km_arc*1000, utbasedata, psym=3, linestyle=1, /notit, ytit='!6Acceleration (m s!U-1!N s!U-1!N)', $
	xr=[t[0]-2000,t[*]+1000], /xs, /ys, yr=[-240,165], pos=[0.15,0.08,0.95,0.38];, ytickname=['-600','-400','-200','0','200','400',' ']
