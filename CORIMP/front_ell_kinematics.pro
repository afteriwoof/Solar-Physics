; Code to read in the CME front and fit an ellipse, taking out the kinematics.
...
; Last Edited: 	13-08-08
;		01-03-11	removed the shift_ell function from the bottom and put in a separate file (in idl_codes/).
;		2013-04-16	to handle more cases of instruements and different header info.
;		2013-07-19	to include specify keyword.

pro front_ell_kinematics, image, errs, in, da, ang, ell_info, r_err, x_ellipse, y_ellipse, perror, max_h_front, max_h_ell, apex_a, noplot, noflank=noflank, specify=specify, no_cone=no_cone, tog=tog
	...
	if noplot ne 1 then begin
		...
		'CMOS 1Kx1K': 	begin
				loadct, 0
				plot_map, map, xr=[-1400,1800], yr=[-1550,1650]
				end
	...
	save, mj1x,mj1y,mj2x,mj2y,mn1x,mn1y,mn2x,mn2y,min_cone_x,min_cone_y,max_cone_x,max_cone_y,f='plot_params.sav'
	;pause	
	;wait, 1
