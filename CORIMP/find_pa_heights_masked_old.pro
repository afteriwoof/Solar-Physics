...
pro find_pa_heights_masked, pa_total, detection_info, plots_fls, plots_list, cme_prof_fl, out_dir, plot_prof=plot_prof, loud=loud, pre_loud=pre_loud, pauses=pauses, pngs=pngs, no_plots=no_plots
...
;						endif
		...
		if i lt detection_info[1,i] then count_kin_profs[k_count-detection_info[0,i]] += 1
