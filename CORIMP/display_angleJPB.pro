PRO display_angleJPB, dmod, dang, drange=drange, pix_step=pix_step
...
window,0,xsize=win_xsize,ysize=win_ysize,tit='(0) Modulus',xpos=200,ypos=200
loadct,0
;STOP
tvscl,dmod^0.25
...
loadct,0
!p.background=255
window,1,xsize=1400,ysize=1000,tit='(1) Angle',xpos=210+win_xsize,ypos=200
;STOP
;tvscl,dmod^0.25
loadct,6
plot_image, dang
...
FOR i=0,1400-1,pix_step DO $
    FOR j=0,1000-1,pix_step DO $
