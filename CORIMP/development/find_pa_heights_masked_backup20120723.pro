...
pro find_pa_heights_masked, fls, pa_total, detection_info, det_fls, det_stack, cme_prof_fl, out_dir, plot_prof=plot_prof, loud=loud, pre_loud=pre_loud, pauses=pauses, pngs=pngs, no_plots=no_plots
...
;						endif
		...
		help, k_count, i, detection_info[1,i], detection_info[0,i], count_kin_profs
