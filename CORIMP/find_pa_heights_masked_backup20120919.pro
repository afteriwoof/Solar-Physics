...
pro find_pa_heights_masked, fls_in, pa_total, detection_info, det_fls, stack_fls, cme_prof_fls, out_dir, plot_prof=plot_prof, loud=loud, pre_loud=pre_loud, pauses=pauses, pngs=pngs, no_plots=no_plots
...
if keyword_set(loud) then print, 'Looping over ', i, ' of ', loop_end; & pause
...
;						endif
		...
		print, 'Saving definite_x, definite_y, and datetime, as cme_kin_prof_?'+int2str(i)+'_?'+int2str(kin_count)+'_?'+ang_int+'.sav'
		kin_count += 1
