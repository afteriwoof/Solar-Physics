; Created	2012-08-02	from combine_pa_heights6_fit.pro to include the interquartile ranges.



pro combine_pa_heights6_fit_quartiles, in, heights, image_no, pos_angles, new_heights, new_image_no, new_pos_angles, gather_t_nows, gather_h_nows, gather_v_nows, gather_a_nows, tog=tog, plot_quartiles=plot_quartiles, plot_median=plot_median, remove_outliers=remove_outliers, saves=saves, model=model
...
if keyword_set(tog) then begin
	toggle, /portrait, /color, f='combine_pa_heights6_fit_quartiles.ps'
	!p.background=1
	!p.charsize=3.0
	!p.charthick=5
	!p.thick=3
