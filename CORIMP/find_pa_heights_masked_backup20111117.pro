...
; Last edite:	20111116	included keyword no_plots to make faster running option for code.
...
;		pause
	...
	save, count_kin_profs, f='count_kin_profs_'+int2str(i)+'.sav'
