; Created: 10-08-10 from plot_slices_paper7.pro to account for changes to Cor2?
...
pro plot_slices_paper8, angle_x, angle_z, mov, nolabels=nolabels, zoom=zoom, no_ell=no_ell, plot_cone=plot_cone, pauses=pauses, no_proj=no_proj, over=over, room_all=room_all
