...
; Last Edited: 05-03-08

pro kins_height_width
...
;parinfo[0].limited = 1
;parinfo[0].limits = 25
;parinfo[1].limits = [400,600]

yf = 'p[0]*x^2. + p[1]*x + p[2]'
f = mpfitexpr(yf, t, h, h_err, [h[0],v[0],a[0]]);, parinfo=parinfo)
...
;utplot, t, h_rsun, utbasedata, psym=3, linestyle=1, ytit='Height (R_sun)', $
;	xr=[t[0]-2000,t[*]+1000], yr=[0,25], /notit, /nolabel, /xs, $
;	xtickname = [' ',' ',' ',' ',' ',' ',' '], $
...
;
;utplot, t, v*km_arc, utbasedata, psym=3, linestyle=1, ytit='Velocity (km/sec)', $
;	/notit, /nolabel, xtickname = [' ',' ',' ',' ',' ',' ',' '], /xs, xr=[t[0]-2000,t[*]+1000], $
;	yr=[150,900], /ys, pos=[0.15,0.38,0.95,0.68];, ytickname=['-500','0','500','1000',' '] 
;outplot, t, v_model*km_arc, utbasedata, psym=-3, linestyle=0
;oploterror, t, v*km_arc, delta_t, v_err*km_arc, psym=3
;
;utplot, t, a*km_arc*1000, utbasedata, psym=3, linestyle=1, /notit, ytit='Acceleration (m/sec^2)', $
;	xr=[t[0]-2000,t[*]+1000], yr=[-150,150], /ys, /xs, pos=[0.15,0.08,0.95,0.38];, ytickname=['-400','-200','0','200','400','600',' ']
