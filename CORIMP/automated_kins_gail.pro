; Created	2014-04-01	from automated_kins_gail_realtime.pro

; Last edited:	


pro automated_kins_gail, startdate, enddate, debug=debug, originals=originals
...
for i_days=0,cntdir-1 do begin
	...
	if n_elements(kin_fls) eq 1 && strlen(kin_fls[0]) eq 0 then goto, jump4
