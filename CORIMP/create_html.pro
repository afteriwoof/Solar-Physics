;Created	2013-02-07	to output a .html file for online catalogue.

;Last edited	2014-01-16	to make the floating box of column titles.
;		2014-01-24	to specify linear, quadratic, or savgol.


pro create_html, in_dir, linear=linear, quadratic=quadratic, sav_gol=sav_gol
...
for i_years=0,n_elements(years)-1 do begin
	...
	months = file_search(years[i_years]+'/*')
		...
		printf, lun, '<a href="../../index.html"><font color=white><u><< CORIMP</u></font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
        	; Kinematic Treatment
		...
		printf, lun, '<script type="text/javascript" src="../../floating-1.12.js"></script>'
		...
		for i_days=0,n_elements(days)-1 do begin
			...
			for i=0,n_elements(fls)-1 do begin
				...
				printf, lun2, '# ACCEL: '+int2str(round(cme_kins.cme_accel))+' [m/s^2]'
				...
				printf, lun, '<a href="'+file_basename(dir)+'/cme_kins/cme_kins_'+dateonly+'_'+timeonly+extn+'.txt" title="see height-time digital file">'
				...
				printf, lun, '<td headers="hd_acc" align=right>'
			        printf, lun, '<a href="'+file_basename(dir)+'/cme_kins/plot_kins_quartiles_'+plot_name+'_'+datetime+extn+'.jpg" title="view kinematic plots">'
			        case flag_nokins of
                                        0:      printf, lun, round(cme_kins.cme_accel)
					1:	printf, lun, '-'
				endcase
			        printf, lun, '</a> </td>'
				...
				printf, lun, '<td headers="hd_acc_max" align=right>'
			        printf, lun, '<a href="'+file_basename(dir)+'/cme_kins/plot_kins_quartiles_'+plot_name+'_'+datetime+extn+'.jpg" title="view kinematic plots">'
			        case flag_nokins of
                                        0:      printf, lun, round(cme_kins.cme_accelmax)
					1:	printf, lun, '-'
				endcase
			        printf, lun, '</a> </td>'
				...
				printf, lun, '<td headers="hd_acc_min" align=right>'
                                printf, lun, '<a href="'+file_basename(dir)+'/cme_kins/plot_kins_quartiles_'+plot_name+'_'+datetime+extn+'.jpg" title="view kinematic plots">'
                                case flag_nokins of
                                        0:      printf, lun, round(cme_kins.cme_accelmin)
                                	1:	printf, lun, '-'
				endcase
				printf, lun, '</a> </td>'
		...
		if keyword_set(sav_gol) then printf, lun, ' Savitsky-Golay filter &nbsp;&nbsp; <a href=realtime_quadratic.html><font color=white><u>Quadratic fits</u></font></a> &nbsp;&nbsp; <a href=realtime_linear.html
><font color=white><u>Linear fits</u></font></a> </center> </font> <br>'
