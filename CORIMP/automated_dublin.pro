; Created	20120413	from automated_gail.pro

; Last Edited:	2014-01-23	to include indir and outdir on declaration line.


pro automated_dublin, startdate, enddate, in_dir, out_dir, overwrite=overwrite, gail=gail
;
...
for i_days=0,cntdir-1 do begin
  ...
  run_automated_new, fls, out_dir, gail=gail, overwrite=overwrite
