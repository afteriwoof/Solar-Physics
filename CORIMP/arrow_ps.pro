...
;		vectors.
PRO ARROW_PS, x0, y0, x1, y1, HSIZE = hsize, COLOR = color, HTHICK = hthick, $
...
for i = 0L, n_elements(x0)-1 do begin		;Each vector
	...
	openu, lun, 'arrow_ps.dat', /append, /get_lun
	printf, lun, xp0, xp1, yp0, yp1, xxp0, xxp1, yyp0, yyp1, dx, dy, f='(f,f,f,f,f,f,f,f,f,f)'
	free_lun, lun
ENDFOR


;save, xp0, xp1, yp0, yp1, xxp0, xxp1, yyp0, yyp1, dx, dy, f='arrow_plots.sav'
