;Edited from Shane's code ace_plotter3.pro

pro ace_plotter, d1, d2, no_lines=no_lines
...
utplot, t, sp, ut[0] , timerange=[anytim(ut[0],/atime),anytim(ut[n_elements(ut)-1],/atime) ],yrange=[280,380], /xstyle, ytitle='Bulk speed [km/s]', $
...
utplot, t, den, ut[0] , timerange=[anytim(ut[0],/atime),anytim(ut[n_elements(ut)-1],/atime) ],yrange=[0,6], /xstyle, ytitle='Density [p/cm!u2!n]', $
...
utplot, t, a.ion_temp, ut[0] , timerange=[anytim(ut[0],/atime),anytim(ut[n_elements(ut)-1],/atime) ],yrange=[0,100000], /xstyle, ytitle='Ion Temperature [k]', $
	xtickname=[' ',' ',' ',' ',' ', ' ', ' '], /nolabel, xmargin =[10, 1], ymargin=[0,0], /ys
...
utplot, tb, b.bx/btot, base, ytitle='Bx/|B|', timerange=[anytim(utb[0],/atime),anytim(utb[n_elements(utb)-1],/atime) ], /xs, $
	xtickname=[' ',' ',' ',' ',' ', ' ', ' '], /nolabel, xmargin =[10, 1], ymargin=[0,0]
...
utplot, tb, b.by/btot, base, ytitle='Bx/|B|', timerange=[anytim(utb[0],/atime),anytim(utb[n_elements(utb)-1],/atime) ], /xs, $
	xtickname=[' ',' ',' ',' ',' ', ' ', ' '], /nolabel, xmargin =[10, 1], ymargin=[0,0]
if ~keyword_set(no_lines) then begin
...
utplot, tb, b.bz/btot, base, ytitle='Bx/|B|', timerange=[anytim(utb[0],/atime),anytim(utb[n_elements(utb)-1],/atime) ], /xs, $
	xtickname=[' ',' ',' ',' ',' ', ' ', ' '], /nolabel, xmargin =[10, 1], ymargin=[0,0]
if ~keyword_set(no_lines) then begin
...
utplot, tb, btot, base, ytitle='|B|', timerange=[anytim(utb[0],/atime),anytim(utb[n_elements(utb)-1],/atime) ], /xs, yr=[0,10],$
