; Created: 11-08-09 from plot_slices_paper4.pro to include a many fronts.
...
pro plot_slices_paper5, angle_x, angle_z, mov, nolabels=nolabels, zoom=zoom, no_ell=no_ell, plot_cone=plot_cone, pauses=pauses, no_proj=no_proj, over=over, room_all=room_all

print, 'Need to use this code from the ~/PhD/Data_Stereo/20081212/combining/cor2/1122/my_scc_measure/slices_all/ folder'
...
goto,jump2
cd,'~/PhD/Data_Stereo/20081212/combining/cor2/1052/my_scc_measure/slices_all'
...
cd,'~/PhD/Data_Stereo/20081212/combining/cor2/1022/my_scc_measure/slices_all'
...
cd,'~/PhD/Data_Stereo/20081212/combining/cor2/0952/my_scc_measure/slices_all'
...
cd,'~/PhD/Data_Stereo/20081212/combining/cor2/0922/my_scc_measure/slices_all'
...
cd,'~/PhD/Data_Stereo/20081212/combining/cor2/0852/my_scc_measure/slices_all'
...
jump2:
cd,'~/PhD/Data_Stereo/20081212/combining/cor2/0822/my_scc_measure/slices_all'
...
cd,'~/PhD/Data_Stereo/20081212/combining/cor2/1452/my_scc_measure/slices_all'
...
goto, jump6
cd,'~/PhD/Data_Stereo/20081212/combining/cor2/1222/my_scc_measure/slices_all'
...
cd,'~/PhD/Data_Stereo/20081212/combining/cor1/0735/my_scc_measure/slices_all'
...
jump6:
goto,jump4
cd,'~/PhD/Data_Stereo/20081212/combining/cor1/0715/my_scc_measure/slices_all'
...
cd,'~/PhD/Data_Stereo/20081212/combining/cor1/0705/my_scc_measure/slices_all'
...
cd,'~/PhD/Data_Stereo/20081212/combining/cor1/0655/my_scc_measure/slices_all'
...
cd,'~/PhD/Data_Stereo/20081212/combining/cor1/0645/my_scc_measure/slices_all'
...
cd,'~/PhD/Data_Stereo/20081212/combining/cor1/0635/my_scc_measure/slices_all'
...
cd,'~/PhD/Data_Stereo/20081212/combining/cor1/0625/my_scc_measure/slices_all'
...
jump4:
cd,'~/PhD/Data_Stereo/20081212/combining/cor1/0615/my_scc_measure/slices_all'
...
num = [1,3,4,7,8,10,11,13,14,15,16,17,18,19,87,88,89,91,92,93,95]
for i=0,20 do begin
	k=num[i]
	print, 'slice'+int2str(k)
	restore, '../slice'+int2str(k)+'/vertices.sav'
