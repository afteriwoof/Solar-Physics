...
pro find_pa_heights_masked_backup20111116, pa_total, detection_info, plots_fls, plots_list, cme_prof_fl, out_dir, plot_prof=plot_prof, loud=loud, pre_loud=pre_loud, pauses=pauses, pngs=pngs
...
;	for k_count=250,detection_info[1,i] do begin
...
;						endif
		...
		count_kin_profs[k_count-detection_info[0,i]] += 1
...
;		pause
	...
	save, count_kins_profs, f=temp+'/count_kins_profs'+int2str(i)+'.sav'
