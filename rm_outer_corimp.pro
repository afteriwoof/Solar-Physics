; Created 28-01-11 from rm_outer.pro to change the hearder info keywords after reading data with mreadfits_corimp.pro

FUNCTION rm_outer_corimp, da, in, dr_px, thr=thr, plot=plot,fill=fill
