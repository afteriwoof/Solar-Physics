; Code to read in the CME front and NOT fit an ellipss, taking out the kinematics.

; This code is called by ell_kinematics.pro which allows an array to be read in together.

; Last Edited: 10-04-08

pro front_kinematics, image, errs, in, da, ang, ell_info, r_err, x_ellipse, y_ellipse, perror
